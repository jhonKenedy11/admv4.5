...
function fechaProdutoPesquisaConsulta(e) {
    debugger;
...
//fecha pesquisa de produto e atualiza campos da form que chamou
function fechaProdutoPermanece(e) {
    debugger;
    f = window.opener.document.lancamento;
    ...
    f.descPermanecer.value       = descricaoProduto  
    window.close();
}

//fecha pesquisa de produto e atualiza campos da form que chamou
function fechaProdutoRetira(e) {
    debugger;
    f = window.opener.document.lancamento;
    ...
    f.descRetirar.value       = descricaoProduto  
    window.close();
}

//fecha pesquisa de produto e atualiza campos da form que chamou
function fechaProdutoReparo(e) {
    debugger;
    f = window.opener.document.lancamento;
    ...
    f.reparoCodProduto.value     = id;
    f.reparoProdDesc.value       = descricaoProduto  
    f.reparoCodFabricante.value  = codFabricante  
    f.reparoQuant.focus();
    window.close();
}
