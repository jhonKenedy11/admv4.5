...
function submitLetra() {
    ...
    f.mod.value = 'ped';
    f.form.value = 'pedido_aprovacao_telhas';
    if(f.checkPeriodo.checked == true){
        f.checkPeriodo.value = 1;
        f.letra.value = f.vendedor.value + "|" + f.pessoa.value + "|" + f.codCotacao.value + "|" + f.ccusto.value + "|" + f.dataIni.value + "|" + f.dataFim.value;
    }else{
        f.checkPeriodo.value = 0;
        f.letra.value = f.vendedor.value + "|" + f.pessoa.value + "|" + f.codCotacao.value + "|" + f.ccusto.value + "||";
