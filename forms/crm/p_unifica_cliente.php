...
//Class p_unifica_cliente
Class p_unifica_cliente extends c_conta {
...
//---------------------------------------------------------------
    function controle() {
        switch ($this->m_submenu) {
            case 'inclui':
                $this->unificaCliente($this->cod_permanecer, $this->cod_retirar)
                ? $this->mostraBaixaCliente(msgUpdate, typSuccess)
                : $this->mostraBaixaCliente(msgNotAdd." Unicação cliente não realizado!!", typError);
                break;
            default:
                $this->mostraBaixaCliente('');
...
//---------------------------------------------------------------
    ...
    function mostraBaixaCliente($mensagem, $tipoMsg = NULL) {
        ...
        $this->smarty->display('unifica_cliente_mostra.tpl');
    }


//fim mostraBaixaClientes
//-------------------------------------------------------------
}

//	END OF THE CLASS
// Rotina principal - cria classe
$consultas = new p_unifica_cliente();
