...
include_once($dir."/../../class/cat/c_acessorio.php");
include_once($dir."/../../bib/c_tools.php");

//Class p_cat_acessorio
Class p_acessorio extends c_acessorio {
...
function controle(){
  switch ($this->m_submenu){
		case 'cadastrar':
			if ($this->verificaDireitoUsuario('CatAcessorio', 'I')){
				$this->desenhaCadastroAcessorio();
			}
			break;
		case 'alterar':
			if ($this->verificaDireitoUsuario('CatAcessorio', 'A')){
        $this->set_acessorio();
				$this->desenhaCadastroAcessorio();
      }
			break;
		case 'inclui':
			if ($this->verificaDireitoUsuario('CatAcessorio', 'I')){
					$this->mostraAcessorio($this->incluiAcessorio());
			}		
			break;
		case 'altera':
			if ($this->verificaDireitoUsuario('CatAcessorio', 'A')){
				$this->mostraAcessorio($this->alteraAcessorio());
			}
			break;
		case 'exclui':
			if ($this->verificaDireitoUsuario('CatAcessorio', 'E')){
          $this->mostraAcessorio($this->excluiAcessorio());
			}
			break;
		default:
  		if ($this->verificaDireitoUsuario('CatAcessorio', 'C')){
				$this->mostraAcessorio('');
  		}
 ...
 */
function desenhaCadastroAcessorio($mensagem=NULL){
    ...
    $this->smarty->display('acessorio_cadastro.tpl');
    
}//fim desenhaCadastroAcessorio

/**
* <b> Listagem de todas as registro cadastrados de tabela banco. </b>
* @param String $mensagem Mensagem que ira mostrar na tela
*/
function mostraAcessorio($mensagem){

  
    $lanc = $this->select_acessorio_geral();
    ...
    $this->smarty->display('acessorio_mostra.tpl');
