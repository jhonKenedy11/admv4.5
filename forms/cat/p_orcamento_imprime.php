...
//Class P_situacao
Class p_orcamento_imprime extends c_atendimento {
...
//---------------------------------------------------------------
//---------------------------------------------------------------
    function mostraOrcamentoImprime($mensagem=NULL, $tipoMsg=NULL) {
        ...
        $this->smarty->display('orcamento_imprime.tpl');
    }
...
$pedido = new p_orcamento_imprime();
