            ...
            case 'cadastraNf':
                ...
                try {
                    ...
                    if ($nf->existeNotaFiscalEntrada() == true){
                        $this->desenhaCadastroOrdemCompraFinanceiro("Nota Fiscal Nº ".$nf->getNumero()." já existente para esse fornecedor", "alert");
                        break;
                    }
                    ...
                    $this->mostraOrdemCompra("Nf Não foi gerado <br>".$e->getMessage(), "ERROR");
                        ...
                        $this->mostraOrdemCompra("Nf Não foi gerada <br>".$e->getMessage(), "ERROR");
