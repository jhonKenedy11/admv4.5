...
//Class p_rel_tabela_precos
Class p_rel_tabela_precos extends c_estoque_rel {
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioTabelaPrecos($mensagem){
    ...
    $lanc = $this->select_relatorio_estoque_geral() ?? [];
    ...
    $this->smarty->display('relatorio_tabela_precos.tpl');
}
...
$produto = new p_rel_tabela_precos();
