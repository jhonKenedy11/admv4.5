...
//Class p_rel_estoque_geral
Class p_rel_estoque_geral extends c_estoque_rel {
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioEstoqueGeral($mensagem){
    ...
    $this->smarty->display('relatorio_estoque_geral.tpl');
}
...
$produto = new p_rel_estoque_geral();
