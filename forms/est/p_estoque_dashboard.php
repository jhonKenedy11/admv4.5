...
require_once($dir . '/../../class/est/c_estoque_dashboard.php');

class p_estoque_dashboard extends c_estoque_dashboard
{
    ...
    public function __construct()
    {
        ...
        $this->smarty->assign('titulo', 'Dashboard de estoque');
    ...
    {
        if ($this->verificaDireitoUsuario('EstoqueDashboard', 'C')) {
    ...
    public function mostraDashboard($mensagem = null)
    {
        ...
        $this->smarty->display('estoque_dashboard_mostra.tpl');
    }
}

$estoqueDashboard = new p_estoque_dashboard();
$estoqueDashboard->controle();
