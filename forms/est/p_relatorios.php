...
//Class P_produto
Class p_relatorios extends c_produto {
...
function mostraRelatorio($mensagem){
    ...
    $lancEntrada = $this->movimento_estoque_entrada($par);
    $lancSaida = $this->movimento_estoque_saida($par);
  ...
  //  $this->smarty->assign('descCondPgto', $descCondPgto);
    ...
    $this->smarty->assign('pedido', $lancEntrada);
    $this->smarty->assign('pedidoSaida', $lancSaida);
 ...
 //   $this->smarty->assign('pedidoItem', $lancItem);
    ...
    $this->smarty->display('relatorio_movimento_estoque.tpl');
    
}

function mostraRelatorioProduto($mensagem) {
