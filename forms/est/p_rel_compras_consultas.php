...
//Class p_rel_compras_consultas
Class p_rel_compras_consultas extends c_estoque_rel {
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioCompras($mensagem){
    ...
    $this->smarty->display('relatorio_compras.tpl');
}
...
$produto = new p_rel_compras_consultas();
