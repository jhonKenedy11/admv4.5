...
/**
 * @package   astec
 * @name      p_rel_tabela_precos_grupos
 * @version   3.0.00
 * @copyright 2016
...
//Class p_rel_tabela_precos_grupo
Class p_rel_tabela_precos_grupo extends c_estoque_rel {
...
//---------------------------------------------------------------
    function controle() {
        switch ($this->m_submenu) {
            default:
                $this->relatorioTabelaPrecosGrupo('');
        } //switch
    }
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioTabelaPrecosGrupo($mensagem){
    ...
    $lanc = $this->select_relatorio_estoque_geral('grupo');
    ...
    $this->smarty->display('relatorio_tabela_precos_grupo.tpl');
}
...
$produto = new p_rel_tabela_precos_grupo();
