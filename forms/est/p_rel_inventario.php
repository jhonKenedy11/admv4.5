...
//Class p_rel_inventario
Class p_rel_inventario extends c_inventario {
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioInventario($mensagem){
    ...
    $lanc = $this->select_inventario_produto_letra($this->m_letra);

    
    $this->smarty->assign('idInventario', $lanc[0]['INVENTARIOID']);
    $this->smarty->assign('pedido', $lanc);
    $this->smarty->assign('periodoIni', $this->m_par[0]);
    $this->smarty->assign('periodoFim', $this->m_par[1]);
    
    $this->smarty->display('relatorio_inventario.tpl');
}
