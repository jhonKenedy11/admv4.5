...
//Class p_rel_material_consumo_conta
Class p_rel_material_consumo_conta extends c_estoque_rel {
...
function relatorioMovEstoqueCliente($mensagem){
    ...
    $this->smarty->display('relatorio_material_consumo_conta.tpl');
}
...
$produto = new p_rel_material_consumo_conta();
