...
//Class p_rel_compras_sugestoes
Class p_rel_compras_sugestoes extends c_estoque_rel {
...
//---------------------------------------------------------------
    function controle() {
        switch ($this->m_submenu) {
            default:
                $this->relatorioComprasSugestoes('');
        } //switch
    }
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function relatorioComprasSugestoes($mensagem){
    ...
    $lanc = $this->select_relatorio_compras_sugestoes();
    ...
    $this->smarty->display('relatorio_compras_sugestoes.tpl');
}
...
$produto = new p_rel_compras_sugestoes();
