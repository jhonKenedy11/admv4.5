...
//Class p_consolidacao_fiscal
Class p_consolidacao extends c_nota_fiscal_produto {
...
function __construct(){
        ...
        $this->smarty->assign('titulo', "Consolidação Fiscal de Estoque");
...
function mostraConsolidacao($mensagem){
    ...
    $this->smarty->display('consolidacao_fiscal_mostra.tpl');
