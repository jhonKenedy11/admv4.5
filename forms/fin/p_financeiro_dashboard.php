...
require_once($dir . '/../../class/fin/c_financeiro_dashboard.php');

class p_financeiro_dashboard extends c_financeiro_dashboard
{
    ...
    public function __construct()
    {
        ...
        $this->smarty->assign('titulo', 'Dashboard financeiro');
    ...
    {
        if ($this->verificaDireitoUsuario('FinanceiroDashboard', 'C')) {
    ...
    public function mostraDashboard($mensagem = null)
    {
        ...
        $this->smarty->display('financeiro_dashboard_mostra.tpl');
    }
}

$financeiroDashboard = new p_financeiro_dashboard();
$financeiroDashboard->controle();
