...
//Class P_FLUXO_CAIXA
Class p_rel_recibo_imprime extends c_lancamento {
...
function mostraLancPed($mensagem){
    ...
    $clienteArray = $consulta->resultado;
    $cliente = $clienteArray[0]['NOME'];
    ...
    $this->smarty->assign('clienteArray', $clienteArray);
    $this->smarty->assign('tipoLancamento', $lanc[0]["TIPOLANCAMENTO"]);
    ...
    $this->smarty->display('rel_recibo_imprime.tpl');
...
$lancPed = new p_rel_recibo_imprime();
