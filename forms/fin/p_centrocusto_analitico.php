...
//Class P_FLUXO_CAIXA
Class p_centrocusto extends c_lancamento {
...
function __construct(){
        ...
        $this->hidden = isset($parmGet['relHidden']) ? $parmGet['relHidden'] : '';
...
//---------------------------------------------------------------
//---------------------------------------------------------------
function mostraCentrocusto($mensagem){
    ...
    if ((isset($this->m_letra)) or ($this->m_letra != '')):
        ...
        $lanc = $this->select_lancamento_letra($this->m_letra,3);
    endif;
    ...
    $this->smarty->assign('hidden', $this->hidden);
...
*/    
    $this->smarty->display('centrocusto_analitico_mostra.tpl');
...
$centrocusto = new p_centrocusto();


$centrocusto->controle();
