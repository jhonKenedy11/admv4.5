...
//Class P_FLUXO_CAIXA
Class p_rel_lanc_ped_data_entrega extends c_lancamento {
...
function mostraLancPed($mensagem){
    ...
    if ((isset($this->m_letra)) or ($this->m_letra != '')):
        $lanc = $this->select_lancamento_x_pedido_letra($this->m_letra) ?? [];
    endif;
    ...
    $this->smarty->display('rel_lanc_ped_data_entrega.tpl');
...
$lancPed = new p_rel_lanc_ped_data_entrega();
