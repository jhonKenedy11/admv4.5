...
Class p_pedido_venda extends c_pedidoVenda {
    ...
    function __construct() {
        ...
        $this->setOdEsferico(isset($parmPost['odEsferico']) ? $parmPost['odEsferico'] : '');
        $this->setOeEsferico(isset($parmPost['oeEsferico']) ? $parmPost['oeEsferico'] : '');
        $this->setOdCilindrico(isset($parmPost['odCilindrico']) ? $parmPost['odCilindrico'] : '');
        $this->setOeCilindrico(isset($parmPost['oeCilindrico']) ? $parmPost['oeCilindrico'] : '');
        $this->setOdEixo(isset($parmPost['odEixo']) ? $parmPost['odEixo'] : '');
        $this->setOeEixo(isset($parmPost['oeEixo']) ? $parmPost['oeEixo'] : '');
        $this->setOdAd(isset($parmPost['odAd']) ? $parmPost['odAd'] : '');
        $this->setOeAd(isset($parmPost['oeAd']) ? $parmPost['oeAd'] : '');
        $this->setMedico(isset($parmPost['medico']) ? $parmPost['medico'] : '');
                ...
                if ($this->verificaDireitoUsuario('EstGrupo', 'A')) {
                    if ($this->getSituacao() == '0'):
                        ...
                        if ($fluxo=='S'):
                            ...
                            $pedidoFinaliza = new p_pedido_venda_nf($this->getId(), 'cadastrar');
...
/*        $parametros = new c_banco;
        ...
        if (($this->m_par[4] != '0') and ($this->m_par[4] != '')){
            $i = 5;
