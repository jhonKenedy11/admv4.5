...
require_once($dir . '/../../class/ped/c_pedido_dashboard.php');

class p_pedido_dashboard extends c_pedido_dashboard
{
    ...
    public function __construct()
    {
        ...
        $this->smarty->assign('titulo', 'Dashboard de pedidos');
    ...
    {
        if ($this->verificaDireitoUsuario('PedidoDashboard', 'C')) {
    ...
    public function mostraDashboard($mensagem = null)
    {
        ...
        $this->smarty->display('pedido_dashboard_mostra.tpl');
    }
}

$pedidoDashboard = new p_pedido_dashboard();
$pedidoDashboard->controle();
