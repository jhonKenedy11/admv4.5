...
//Class p_pedido_aprovacao_telhas
Class p_pedido_aprovacao_telhas extends c_pedido_aprovacao {
    ...
    function controle() {
        switch ($this->m_submenu) {
            ...
            case 'aprovado':
                ...
                $this->mostraPedidoAprovacao('O Documento '.$this->m_id.' foi Aprovado.', 'sucesso');
                break; 
            case 'desaprovado':
...
//---------------------------------------------------------------
    function mostraPedidoAprovacao($mensagem=NULL,  $tipoMsg = NULL) {        
        ...
        if($this->m_par[4] == "") {
            ...
            $this->smarty->assign('dataIni', $this->m_par[4]);
        }
        ...
        if($this->m_par[5] == "") {
            ...
            $this->smarty->assign('dataFim', $this->m_par[5]);
        }
        ...
        $this->smarty->display('pedido_aprovacao_telhas_mostra.tpl');
    }
...
$pedidoAprovacao = new p_pedido_aprovacao_telhas();
