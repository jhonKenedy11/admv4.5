...
//Class p_rel_bonus
Class p_rel_bonus extends c_pedido_venda_relatorios {
    ...
    function __construct() {
       ...
       // Cria uma instancia variaveis de sessao
        ...
        $this->pessoa=(isset($parmGet['pessoa']) ? $parmGet['pessoa'] : '');
...
//---------------------------------------------------------------
    function relatorioBonus(){
        ...
        $this->smarty->display('relatorio_bonus.tpl');
