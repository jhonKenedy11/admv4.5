...
<table>
    <tr>
        <td class="borda-left" style="width: 150px; vertical-align: bottom; padding: 3pt;">
            <img src="images/blt/logoitau.jpg" width="120" height="30">
        </td>
    ...
    <tr>
        <td colspan="6">
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
                ...
                <tr><td class="campo-valor" style="border:none;">Pagável Preferencialmente na Rede Itau</td></tr>
            </table>
        </td>
        <td>
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
...
<table>
    ...
    <td colspan="6">
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
                <tr><td class="campo-titulo" style="border:none;">Local de Pagamento</td></tr>
                <tr><td class="campo-valor" style="border:none;">Pagável Preferencialmente na Rede Itau ou no Itau Expresso</td></tr>
            </table>
        </td>
        <td>
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
