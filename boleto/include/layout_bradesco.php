...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <TBODY>
        <TR>
            <TD class=ct width=666><img height=1 src=images/blt/6.png width=665 border=0></TD>
        </TR>
        <TR>
            <TD class=ct width=666>
                <div align=right><b class=cp>Recibo do Pagador</b>
                </div>
            </TD>
        </tr>
    </tbody>
...
<BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="images/blt/logobradesco.jpg" width="150" height="40" 
      border=0></span></td>
<td width=3 valign=bottom><img height=22 src=images/blt/3.png width=2 border=0></td>
<td class=cpt width=58 valign=bottom>
    <div align=center><font class=bc><?php echo $dadosboleto["codigo_banco_com_dv"]?></font>
    </div>
</td>
<td width=3 valign=bottom><img height=22 src=images/blt/3.png width=2 border=0></td>
<td class=ld align=right width=453 valign=bottom>
    ...
    <tbody>
        <tr>
            <td colspan=5><img height=2 src=images/blt/2.png width=666 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        <tr>
            <td class=ct valign=top width=7 height=13><img height=13 src=images/blt/1.png width=1 border=0></td>
            ...
            <td class=ct valign=top width=7 height=13><img height=13 src=images/blt/1.png width=1 border=0></td>
            <td class=ct valign=top width=34 height=13>Moeda</td>
            <td class=ct valign=top width=7 height=13><img height=13 src=images/blt/1.png width=1 border=0></td>
        ...
        <tr>
            <td class=cp valign=top width=7 height=12><img height=12 src=images/blt/1.png width=1 border=0></td>
        ...
        <tr>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=298 height=1><img height=1 src=images/blt/2.png width=298 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=126 height=1><img height=1 src=images/blt/2.png width=126 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=34 height=1><img height=1 src=images/blt/2.png width=34 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=53 height=1><img height=1 src=images/blt/2.png width=53 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=120 height=1><img height=1 src=images/blt/2.png width=120 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=113 height=1><img height=1 src=images/blt/2.png width=113 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=72 height=1><img height=1 src=images/blt/2.png width=72 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=132 height=1><img height=1 src=images/blt/2.png width=132 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=134 height=1><img height=1 src=images/blt/2.png width=134 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=180 height=1><img height=1 src=images/blt/2.png width=180 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            ...
            <td valign=top width=113 height=1><img height=1 src=images/blt/2.png width=113 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=112 height=1><img height=1 src=images/blt/2.png width=112 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=113 height=1><img height=1 src=images/blt/2.png width=113 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=113 height=1><img height=1 src=images/blt/2.png width=113 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=659 height=1><img height=1 src=images/blt/2.png width=659 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <tr>
        <td class=cp width=150> 
          <span class="campo"><IMG src="images/blt/logobradesco.jpg" width="150" height="40" border=0>
          </span>
        </td>
        <td width=3 valign=bottom><img height=22 src=images/blt/3.png width=2 border=0></td>
        <td class=cpt width=58 valign=bottom>
...
<tr>
    ...
    <td class=cp valign=top width=472 height=12>
       Pagável Preferencialmente na rede Bradesco ou no Bradesco expresso </td>
    <td class=cp valign=top width=7 height=12><img height=12 src=images/blt/1.png width=1 border=0></td>
    <td class=cp valign=top align=right width=180 height=12> 
          <span class="campo">
          <?php echo $dadosboleto["data_vencimento"]?>
...
<tr>
    <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
    <td valign=top width=472 height=1><img height=1 src=images/blt/2.png width=472 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
    <td valign=top width=180 height=1><img height=1 src=images/blt/2.png width=180 border=0></td>
</tr>
</tbody>
    ...
    <tbody>
        <tr>
            <td class=ct valign=top width=7 height=13>
                <img height=13 src=images/blt/1.png width=1 border=0>
            </td>
            <td class=ct valign=top width=472 height=13>Nome do Beneficiário</td>
            <td class=ct valign=top width=7 height=13>
                <img height=13 src=images/blt/1.png width=1 border=0></td>
            <td class=ct valign=top width=180 height=13>Agência/Código beneficiário</td>
        </tr>
        <tr>
            <td class=cp valign=top width=7 height=12>
                <img height=12 src=images/blt/1.png width=1 border=0></td>
            <td class=cp valign=top width=472 height=12> 
                  <span class="campo">
                  <?php echo $dadosboleto["cedente"]?>
                  </span>
        ...
        <tr>
            <td valign=top width=7 height=1>
                <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=472 height=1>
                <img height=1 src=images/blt/2.png width=472 border=0></td>
            <td valign=top width=7 height=1>
                <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=180 height=1>
                <img height=1 src=images/blt/2.png width=180 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            ...
            <td valign=top width=113 height=1><img height=1 src=images/blt/2.png width=113 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=153 height=1><img height=1 src=images/blt/2.png width=153 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=62 height=1><img height=1 src=images/blt/2.png width=62 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=34 height=1><img height=1 src=images/blt/2.png width=34 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=82 height=1><img height=1 src=images/blt/2.png width=82 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=180 height=1> <img height=1 src=images/blt/2.png width=180 border=0></td>
        </tr>
    </tbody>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        <tr> 
            ...
            <td class=ct valign=top height=13 width=7> <img height=13 src=images/blt/1.png width=1 border=0></td>
            <td class=ct valign=top width=83 height=13>Carteira</td>
            <td class=ct valign=top height=13 width=7> <img height=13 src=images/blt/1.png width=1 border=0></td>
            <td class=ct valign=top width=53 height=13>Moeda
            <td class=ct valign=top height=13 width=7> <img height=13 src=images/blt/1.png width=1 border=0></td>
        ...
        <tr>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=75 border=0></td>
            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=31 height=1><img height=1 src=images/blt/2.png width=31 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=83 height=1><img height=1 src=images/blt/2.png width=83 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=53 height=1><img height=1 src=images/blt/2.png width=53 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=123 height=1><img height=1 src=images/blt/2.png width=123 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=72 height=1><img height=1 src=images/blt/2.png width=72 border=0></td>
            <td valign=top width=7 height=1> <img height=1 src=images/blt/2.png width=7 border=0></td>
            <td valign=top width=180 height=1><img height=1 src=images/blt/2.png width=180 border=0></td>
            ...
            <td align=right width=10>
                <table cellspacing=0 cellpadding=0 border=0 align=left>
                    <tbody> 
                        ...
                        <tr> 
                            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=1 border=0></td>
                        </tr>
                    </tbody>
                </table>
            </td>
            <td valign=top width=468 rowspan=5><font class=ct>Informações de responsabilidade do beneficiário</font>
                <br><br>
            ...
            <td align=right width=188>
                <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                        ...
                        <tr>
                            <td class=cp valign=top width=7 height=12> <img height=12 src=images/blt/1.png width=1 border=0></td>
                            <td class=cp valign=top align=right width=180 height=12></td></tr>
                        <tr>
                            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=7 border=0></td>
                            <td valign=top width=180 height=1><img height=1 src=images/blt/2.png width=180 border=0></td>
                        </tr>
            ...
            <td align=right width=10>
                <table cellspacing=0 cellpadding=0 border=0 align=left>
                    <tbody>
                        ...
                        <tr>
                            <td valign=top width=7 height=1><img height=1 src=images/blt/2.png width=1 border=0></td></tr>
                    </tbody>
                </table>
            </td>
            <td align=right width=188> 
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <tbody>
        <tr>
            <td valign=top width=666 height=1><img height=1 src=images/blt/2.png width=666 border=0></td>
        </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0><tbody>
        <tr>
            <td class=ct valign=top width=7 height=13><img height=13 src=images/blt/1.png width=1 border=0></td>
            <td class=ct valign=top width=659 height=13>Nome do Pagador</td>
        </tr>
        <tr>
            <td class=cp valign=top width=7 height=12><img height=12 src=images/blt/1.png width=1 border=0></td>
            <td class=cp valign=top width=659 height=12>
