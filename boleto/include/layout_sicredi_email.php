...
<table>
    <tr>
        <td class="borda-left" style="width: 150px; vertical-align: bottom; padding: 3pt;">
            <img src="<?php echo rtrim(defined('ADMraizFonte') ? ADMraizFonte : dirname(__DIR__, 2), '/'); ?>/boleto/imagens/logosicredi.png" width="140" height="35">
        </td>
    ...
    <tr>
        <td colspan="6">
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
                ...
                <tr><td class="campo-valor" style="border:none;">Pagável em qualquer Banco até o vencimento</td></tr>
            </table>
        </td>
        <td>
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
...
<table>
    ...
    <tr>
        ...
        <td>
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: none;">
                <tr><td class="campo-titulo" style="border:none; text-align:">Agência/Código Beneficiário</td></tr>
                <tr><td class="campo-valor" style="border:none; text-align: center;"><?php echo $dadosboleto["agencia_codigo"]?></td></tr>
            </table>
        </td>
    </tr>
