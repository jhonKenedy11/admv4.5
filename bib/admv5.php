...
class Admv5 {
     ...
     */
    protected static $API_ROOT_URL = "https://admv5.admsistema.com.br";
    ...
    public static $AUTH_URL = array(
        ...
        "ADMV5" => "https://global-selling.mercadolibre.com"  // CBT
    );
    ...
    public function authorize($code, $redirect_uri) {
        ...
        $body = array(
            "LOGIN" => $this->client_id, 
            "SENHA" => $this->client_secret, 
        );
