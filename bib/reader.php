        ...
        if ($this->_defaultEncoding){
            switch ($this->_encoderFunction){
                case 'iconv' :    
                    ...
                    // $chain = iconv('UTF-8', $this->_defaultEncoding, $string);
                    // $tab = array("UTF-16LE", "UTF-8", "ASCII", "Windows-1252", "ISO-8859-15", "ISO-8859-1", "ISO-8859-6", "CP1256", "CP1252", "CP1251"); 
                    // $chain = ""; 
                    // $chain1 = ""; 
                    // foreach ($tab as $i) 
                    //     { 
                    //         foreach ($tab as $j) 
                    //         { 
                    //             $chain .= " $i$j ".iconv($i, $j, "$string"); 
                    //             $chain1 .= " $i$j ".mb_convert_encoding($string, $i, $j);
                    //         } 
                    //     } 
                    // return $chain;    
