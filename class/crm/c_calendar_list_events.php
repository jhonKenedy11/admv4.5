...
include_once($dir . "/../../class/crm/c_contas_acompanhamento.php");
    ...
    $vendedor = $this->session->m_userid;
    ...
    $query_events .= "fc.NOME AS cliente_nome, fc.FONE AS cliente_telefone, fc.CELULAR as cliente_celular, fc.EMAIL as cliente_email ";
    ...
    $query_events .= "WHERE fca.USRVENDEDOR = ". $vendedor . ";";
    ...
    while($row_events = $resultado_events->fetch(PDO::FETCH_ASSOC)){
        ...
        $cliente_email    = $row_events['cliente_email'];
