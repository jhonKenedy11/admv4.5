...
public static function select_consulta_produto_preco($letra){
    ...
    $sqlS  .= " PED.OS AS 'OS' ,(PI.TOTAL - ((PI.TOTAL * PI.PERCDESCONTO)/100)) AS TOTALITEM ";
    ...
    $sqlE  = "SELECT CI.CODIGONOTA, NFP.QUANT ,NF.NUMERO, 'NF ENTRADA' AS TIPO, NF.ORIGEM, NF.DOC, NF.EMISSAO, ";
    ...
    $sqlE  .= " '' AS  'OS', (CI.TOTAL - ((CI.TOTAL * CI.PERCDESCONTO)/100) + NFP.VALORICMSST) AS TOTALITEM ";
    ...
    $sqlPed .= " PED.OS AS 'OS' , (PI.TOTAL - ((PI.TOTAL * PI.PERCDESCONTO)/100)) AS TOTALITEM "; 
