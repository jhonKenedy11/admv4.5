...
public function buscaCadastroLancamentoAdd(){
	...
	$this->setMovimento('');
	$this->setOriginal(number_format($lanc[0]['ORIGINAL'], 2, ',', '.'));
	$this->setMulta(number_format($lanc[0]['MULTA'], 2, ',', '.'));
	$this->setJuros(number_format($lanc[0]['JUROS'], 2, ',', '.'));
	$this->setAdiantamento(number_format((float)$lanc[0]['ADIANTAMENTO'], 2, ',', '.'));
