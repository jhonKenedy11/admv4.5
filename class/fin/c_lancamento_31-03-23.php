...
private $multa = NULL; //	 numeric(9,2),
private $juros = NULL; //	 numeric(9,2),
private $adiantamento = NULL; //	 numeric(11,2),
private $desconto = NULL; //	 numeric(9,2),
private $total = NULL; //	 numeric(11,2),
...
public function getPessoaEmail(){ return $this->emailPessoa; }

public function setDocto($docto){ $this->docto= $docto; }
...
public function setParcela($parcela){ $this->parcela= strtoupper($parcela); }
...
public function setTipodocto($tipodocto){ $this->tipodocto= strtoupper($tipodocto); }
public function getTipodocto(){ return $this->tipodocto; }

public function setSitdocto($sitdocto){ $this->sitdocto= strtoupper($sitdocto); }
public function getSitdocto(){ return $this->sitdocto; }

public function setSitpgtoAnt($sitpgtoAnt){ $this->sitpgtoAnt = strtoupper($sitpgtoAnt); }
public function getSitpgtoAnt(){ return $this->sitpgtoAnt; }

public function setSitpgto($sitpgto){ $this->sitpgto= strtoupper($sitpgto); }
public function getSitpgto(){	return $this->sitpgto;}

public function setUsrsitpgto($usrsitpgto){ $this->usrsitpgto= $usrsitpgto; }
public function getUsrsitpgto(){ return $this->usrsitpgto; }

public function setModopgto($modopgto){ $this->modopgto= strtoupper($modopgto); }
public function getModopgto(){ return $this->modopgto; }

public function setDocbancario($docbancario){ $this->docbancario= strtoupper($docbancario); }
public function getDocbancario(){ return $this->docbancario; }
...
public function setNumlcto($numlcto){ $this->numlcto= $numlcto; }
...
public function setCheque($cheque){ $this->cheque= strtoupper($cheque); }
public function getCheque(){ return $this->cheque; }

public function setUsraprovacao($usraprovacao){ $this->usraprovacao= $usraprovacao; }
public function getUsraprovacao(){ return $this->usraprovacao; }
...
public function setVencimento($venc) { $this->vencimento=$venc; }
...
public function setMovimento($pag) { $this->pagamento=$pag; }
...
public function setMoeda($moeda) { $this->moeda = 0; }
public function getMoeda() { return $this->moeda; }
...
public function setObsContabil($obscontabil){ $this->obscontabil = strtoupper($obscontabil); }
public function getObsContabil(){ return $this->obscontabil; }

public function setContabil($contabil){ $this->contabil = 'N'; }
public function getContabil(){ return $this->contabil; }

public function setQuantParc($quantparc) { $this->quantparc = $quantparc; }
public function getQuantParc() { return $this->quantparc; }

public function setRemessaNum($remessanum) { $this->remessanum = $remessanum; }
public function getRemessaNum() { return $this->remessanum; }

public function setRemessaArq($remessaarq) { $this->remessaarq = $remessaarq; }
public function getRemessaArq() { return $this->remessaarq; }

public function setRemessaData($remessadata) { $this->remessadata = $remessadata; }
public function getRemessaData() { return $this->remessadata; }

public function setNossoNumero($nossonumero) { $this->nossonumero = $nossonumero; }
public function getNossoNumero() { return $this->nossonumero; }

public function setRetornoArq($retornoarq) { $this->retornoarq = $retornoarq; }
public function getRetornoArq() { return $this->retornoarq; }

public function setRetornoCod($retornocod) { $this->retornocod = $retornocod; }
public function getRetornoCod() { return $this->retornocod; }

public function setRetornoCodRejeicao($retornocodrejeicao) { $this->retornocodrejeicao = $retornocodrejeicao; }
public function getRetornoCodRejeicao() { return $this->retornocodrejeicao; }

public function setRetornoCodBaixa($retornocodbaixa) { $this->retornocodbaixa = $retornocodbaixa; }
public function getRetornoCodBaixa() { return $this->retornocodbaixa; }

public function setRetornoDataLiq($retornodataliq) { $this->retornodataliq = $retornodataliq; }
public function getRetornoDataLiq() { return $this->retornodataliq; }
//############### FIM SETS E GETS ###############
 ...
 */
public function gravaNossoNumero($id, $nn){
...
public function addParcelas($arrParFin = NULL, $arrParcelas = NULL, $conn=null){
	...
	$this->setDesconto(0);
        ...
        //     if(($this->getSitpgto() != 'B')and($this->getSitpgto() != 'BAIXADO')){
            if (!$this->existeDocumento())
                $this->incluiLancamento($conn);
        //     }
	}
    return $count;
} //fim addParcelasNf
 ...
 * @return bool $banco->resultado - True ou False se encontrou algum registro ou nao
 */
public function verificaDocBaixado($pessoa, $doc, $origem){
 ...
 */
public function alteraSituacaoFinanceiro($pessoa, $doc, $origem, $situacao){
...
public function add_parc_lancamento(){
	...
	for ($i=0; $i < $this->getQuantParc(); $i++){
		...
		// $this->setSitdocto("V");
                $this->setOriginal($original, true);
                $this->setMulta($multa, true);
                $this->setJuros($juros, true);
                $this->setAdiantamento($adiantamento, true);
                $this->setDesconto($desconto, true);
 ...
 * @return array $banco->resultado - resultado da pesquisa sql na tabela lancamento doc
 */
public function select_lancamento_doc($origem, $doc, $conn=null){
	$sql  = "SELECT PARCELA, VENCIMENTO, TOTAL AS VALOR, CONTA, TIPODOCTO, SITPGTO, OBS ";
   	$sql .= "FROM FIN_LANCAMENTO where (origem = '".$origem."') and (numlcto='".$doc."') ";
...
public function select_lancamento_x_pedido_letra($letra, $total=0, $conta=0){
        ...
        if ($total==3){
                ...
                $sqln .= "IF(P.DATAENTREGA <> '', 'ENTREGUE', 'A ENTREGAR') AS SITUACAOPED, ";
...
public function select_lancamento_letra($letra, $total=0, $conta=0){
        ...
        if ($total==3){
                ...
                $sqln .= "c.pessoa, c.cnpjcpf, CONCAT(c.tipoend,' ',c.tituloend,' ',c.endereco,',',c.numero) as endereco, C.CEP, a.".$dateOrder." AS DATEORDER, '".$dateOrder."' AS FIELDORDER ";
                $sqln .= "FROM FIN_LANCAMENTO a ";
                $sqln .= "inner join fin_centro_custo r on a.centrocusto = r.centrocusto ";
        }
        $sqln .= "inner join fin_cliente c on c.cliente = a.pessoa ";
...
*/
public function incluiLancamento($conn=null){
...
public function alteraLancamento(){
	...
	if($res_lancamento){
		/*if (($this->getSitpgto() == 'B') and ($this->getSitpgto() != $this->getSitpgtoAnt())) {
			$this->setPessoaNome();
			$body  = "Confirmação de Pagamento ".$this->getPessoaNome()."<font size=\"4\"> </font>, <p>";
			$body .= "<i>Pagamento no Valor de </i>".$this->getTotal('F')."   <p>";
			$body .= "Referente a ".$this->getGenero()." - ".$this->getDescGenero()." na data de ".$this->getMovimento('F');
			$body .= "<br> Obs: ".$this->getObs();
		
			$mail = new Mail;
			$mail->SendMail("mail.admervice.com.br", "adm@admservice.com.br", $this->m_empresanome, "adm=2013#-",
				$body, "Confirmacão Pagamento",	$this->getPessoaEmail(), $this->getPessoaNome(), "", "");
		
		}	*/
                return 'Os dados do Lan&ccedil;amento '. $this->getDocto(). ' foram alterados!';
	}
	else{
                return 'Os dados do Lan&ccedil;amento '. $this->getDocto(). ' NÃO foram alterados!';
	}
...
public function somaTotalDocBaixado($pessoa, $doc, $origem){
