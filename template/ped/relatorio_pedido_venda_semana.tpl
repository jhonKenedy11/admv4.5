...
<section class="height100">
    <div class="right_col" role="main">
        ...
        <div class="col-md-5 col-sm-5 col-xs-5">
            <h2>
                <strong>PEDIDO VENDAS SEMANAL</strong><br>
                                ...
                                <div class="col-xs-12 table">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {assign var="totalSemana" value=0}
                                            {assign var="totalDiaCusto" value=0}
                                            {assign var="totalSemanaCusto" value=0}
                                            {section name=i loop=$pedido}
                                                ...
                                                {if $pedido[i].EMISSAO neq $dia }
                                                    ...
                                                    {if $dia neq ""}
                                                        <tr>
                                                            ...
                                                            {if $tipoUsuario neq ""}
                                                                <td>
                                                                    <h4>R$ {$totalDiaCusto|number_format:2:",":"."}</h4>
                                                                </td>
                                                            {/if}
                                                            <td>
                                                                <h4>R$ {$totalDia|number_format:2:",":"."}</h4>
                                                            </td>
                                                    ...
                                                    {/if}
                                                    {if $weekday > $pedido[i].EMISSAO|date_format:"%w" }
                                                        <tr>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            ...
                                                            {if $tipoUsuario neq ""}
                                                                <td>
                                                                    <h4>R$ {$totalSemanaCusto|number_format:2:",":"."}</h4>
                                                                </td>
                                                            {/if}
                                                            <td>
                                                                <h4>R$ {$totalSemana|number_format:2:",":"."}</h4>
                                                            </td>
                                                    ...
                                                    {/if}
                                                    <th id="date">{$pedido[i].EMISSAO|date_format:"%d/%m/%Y"} |
                                                        {$pedido[i].DIASEMANA}</th>
                                                    {assign var="dia" value=$pedido[i].EMISSAO}
                                                    {assign var="weekday" value=$pedido[i].EMISSAO|date_format:"%w"}
                                                {/if}
                                                ...
                                                <tr>
                                                    ...
                                                    {if $tipoUsuario neq ""}<td>
                                                            {$pedido[i].CUSTOTOTAL|number_format:2:",":"."}</td>
                                                    {/if}
                                                ...
                                                {assign var="totalSemana" value=$totalSemana+$pedido[i].TOTAL}
                                                {assign var="totalDia" value=$totalDia+$pedido[i].TOTAL}
                                                {assign var="totalDiaCusto" value=$totalDiaCusto+$pedido[i].CUSTOTOTAL}
                                                {assign var="totalSemanaCusto" value=$totalSemanaCusto+$pedido[i].CUSTOTOTAL}
                                                ...
                                                <tr>
                                                    ...
                                                    {if $tipoUsuario neq ""}
                                                        <td>
                                                            <h4>R$ {$totalCusto|number_format:2:",":"."}</h4>
                                                        </td>
                                                    {/if}
                                                    <td>
                                                        <h4>R$ {$total|number_format:2:",":"."}</h4>
                                                    </td>
...
<script type="text/javascript">
    function exportarTabelaParaExcel() {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Pedidos Semanal");

        var dataIni = '{$dataIni}';
        var dataFim = '{$dataFim}';
        var nomeArquivo = 'Pedido_Vendas_Semanal_' +
