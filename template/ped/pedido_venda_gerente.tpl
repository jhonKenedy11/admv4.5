...
<script type="text/javascript" src="{$pathJs}/ped/s_pedido_venda_conferencia.js"> </script>
    ...
    <div class="right_col" role="main">      
        <div class="">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Gerencia de Pedidos<br></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="page-title">
                 
                    <div class="btn-group">
                        <button id="btnFilter" type="button" class="btn btn-dark btn-xs dropdown-toggle" style="margin-right: 5px;" onclick="javascript:submitFiltroDia();">Mostrar Pedidos Dia</button>
                        <button id="btnFilter" type="button" class="btn btn-dark btn-xs dropdown-toggle" style="margin-right: 5px;" onclick="javascript:submitFiltroSemana();">Mostrar Pedidos Semana</button>
                        <button id="btnFilter" type="button" class="btn btn-dark btn-xs dropdown-toggle" style="margin-right: 5px;" onclick="javascript:submitUltimoMes();">Mostrar Pedidos Ultimo Mes</button>
                        <button id="btnFilter" type="button" class="btn btn-dark btn-xs dropdown-toggle" style="margin-right: 5px;" onclick="javascript:submitFiltroMes();">Mostrar Pedidos Mês</button>
                    </div>
                </div>
            <div class="clearfix"></div>
                ...
                <table id="datatable-buttons" class="table table-bordered jambo_table">
                    <thead>
                        <tr style="background: green; color: white;">
                            ...
                            <th>Emiss&atilde;o</th>
                            <th>Total</th>
                            <th style="width: 180px;">A&ccedil;&otilde;es</th>
                    ...
                    <tbody>
                        ...
                        {section name=i loop=$lanc}
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-xs" title="Cadastrar parcelas no financeiro"
                                        onclick="javascript:submitCadastroFinanceiro('{$lanc[i].ID}');">Financeiro</button>
                                    <button type="button" class="btn btn-primary btn-xs" title="Emitir nota fiscal"
                                        onclick="javascript:submitCadastro('{$lanc[i].ID}');">Nota Fiscal</button>
                                </td>
                                <!--td >
