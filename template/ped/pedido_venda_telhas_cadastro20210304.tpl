            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">                        
                        ...
                        <li><button type="button" class="btn btn-primary"  onClick="javascript:submitSalvar('');">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:atualizaCustoNovo({$id}, nritem.value, custo.value, totalitem.value, quantidade.value, descricao.value, codigo.value, estoque.checked);">Confirma</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    </div>
                </div>
            </div>
