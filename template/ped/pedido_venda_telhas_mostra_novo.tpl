                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-expanded="false"><i class="fa fa-print"></i></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('');"><span> Relatório
                                                Vendas</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            onClick="javascript:relatorioVendas('Entregas');"><span> Relatório de
                                                Entregas</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Mes');"><span> Relatório Vendas
                                                Mes</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Item');"><span> Relatório Vendas
                                                Item</span></button>
                                    ...
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Fatura');"><span> Relatório Vendas
                                                Fatura</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Motivo');"><span> Relatório Vendas
                                                Motivo</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Semana');"><span> Relatório Vendas
                                                Semana</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Vendedor');"><span> Relatório Vendas
                                                Vendedor</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('Detalhado');"><span> Relatório Vendas
                                                Detalhado</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            onClick="javascript:relatorioFaturaAnalitico();"><span> Relatório Vendas
                                                Fatura Analítica</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            onClick="javascript:relatorioFaturaSintetico();"><span> Relatório Vendas
                                                Fatura Sintética</span></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-dark btn-xs" data-toggle="modal"
                                            data-target="#modalInutiliza"
                                            onClick="javascript:relatorioVendas('CondPagamento');"><span> Relatório
                                                Vendas Cond Pagamento</span></button>
                                    </li>
                                </ul>
                            </li>
                                            ...
                                            <div class="panel-body">
                                                <div class="x_panel">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <SELECT {if ($verSomenteInfoDaLoja == false)} enable 
                                                        {else}
                                                            disabled {/if} class="select2_multiple form-control"
                                                            multiple="multiple" id="centroCusto" name="centroCusto">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <SELECT class="select2_multiple form-control"
                                                            multiple="multiple" id="motivo" name="motivo">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <SELECT {if ($vertodoslancamentos )} enable 
                                                        {else} disabled
                                                            {/if} class="select2_multiple form-control"
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <SELECT class="select2_multiple form-control"
                                                            multiple="multiple" id="condPag" name="condPag">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input hidden type="text" name="cotacao" id="cotacao"
                                                    value="{$cotacao}">
                                                <label>Motivo</label>
                                                <div class="panel panel-default small">
                                                    <select name="motivoPerdido" id="motivoPerdido"
                                                        class="form-control">
                                                        {html_options values=$motivo_ids output=$motivo_names selected=$motivo_id}
                                                    </select>
                                                </div>
                    ...
                    <table id="datatable-buttons" class="table table-bordered jambo_table">
                        ...
                        <thead>
                            <tr class="headings">
                                ...
                                <th style="width: 55px;">Data Emissao</th>
                                <th style="width: 55px;">Prazo Entrega</th>
                                <th style="width: 55px;">Entregue</th>
                                <th>Total</th>
                                <th style="width: 95px;">
                                    <center>Manuten&ccedil;&atilde;o</center>
                                </th>
                        ...
                        <tbody>
                            ...
                            {section name=i loop=$lanc}
                                ...
                                <tr>
                                    ...
                                    <td> {$lanc[i].NOME} </td>
                                    <td>
                                        <center> {$lanc[i].VENDEDOR} </center>
                                    </td>
                                    <td>
                                        <center> {$lanc[i].EMISSAO|date_format:"%d/%m/%Y"} </center>
                                    </td>
                                    <td>
                                        <center> {$lanc[i].PRAZOENTREGA} </center>
                                    </td>
                                    ...
                                    <td>
                                        {if $sistema eq "PECAS"}
                                            ...
                                            <button type="button" class="btn btn-info btn-xs"
                                                onclick="javascript:printRomaneio('{$lanc[i].ID}');"><span
                                            ...
                                            {else} disabled
                                                {/if} type="button" class="btn btn-info btn-xs" id="btnEmail"
                                        ...
                                        {else}
                                            <button {if ($lanc[i].SITUACAO == 10) } 
                                                {if ($permiteAprovarPedidos == true)} enable
                                                    {else} disabled 
                                                    {/if} 
                                            ...
                                            {if ($lanc[i].SITUACAO == 5) or ($lanc[i].SITUACAO == 10)}
                                                ...
                                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                                                    data-target="#modalVendaPerdida" onclick="vendaPerdida({$lanc[i].ID})"><span
                                                        span class="glyphicon glyphicon-alert" aria-hidden="true"
                                                        data-toggle="tooltip" title="Venda Perdida"></span></button>
                                            {/if}
                                            <!--button {if ($lanc[i].SITUACAO != 6)} disabled {/if} type="button" title="Autoriza NFe" class="btn btn-info btn-xs" onclick="javascript:submitNFE('{$lanc[i].ID}');"><span class="glyphicon glyphicon-font" aria-hidden="true"></span></button-->
                                            <button {if ($lanc[i].SITUACAO == 7)} disabled {/if} type="button"
                                                ...
                                                onclick="javascript:submitExcluir('{$lanc[i].ID}');" {else}
                                                    ...
                                                    {/if}><span class={if ($lanc[i].SITUACAO == 0)} "glyphicon glyphicon-remove"
                                                    {else} "glyphicon glyphicon-print" 
                                                    {/if} aria-hidden="true"
                                                    data-toggle="tooltip"
                                                    {if ($lanc[i].SITUACAO == 0)}title="Excluir">{else}title="Impressão">{/if}</span></button>
                                            <button {if ($lanc[i].SITUACAO != 6) and ($lanc[i].SITUACAO != 9)} disabled {/if}
                                            ...
                                            <button {if (($lanc[i].SITUACAO == 5) or ($lanc[i].SITUACAO == 6))} 
                                            {else} disabled
                                                {/if} type="button" class="btn btn-xs" id="btnEmail" data-toggle="modal"
                                                data-backdrop="static" data-target="#modalEmail"
                                                onclick="javascript:buscaEmailCliente('{$lanc[i].ID}','{$lanc[i].CLIENTE}');"><span
                                                    class="glyphicon glyphicon-envelope" aria-hidden="true"
                                                    title="Enviar Email"></span></button>
                                        {/if}
                                ...
                                <p>
                                {/section}
                            <div id="popup" title="IMPRIMIR ROMANEIO!"></div>
                        </tbody>
                    </table>
                </div> <!-- div class="x_content" = inicio tabela -->
            </div> <!-- div class="x_panel" = painel principal-->
