            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="col-md-2">
                                ...
                                <input class="form-control money" type="text" id="descontoItem" name="descontoItem">
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:atualizaCustoNovo({$id}, nritem.value, custo.value, totalitem.value, quantidade.value, descricao.value, codigo.value, estoque.checked, descontoItem.value);">Confirma</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    </div>
                </div>
            </div>
