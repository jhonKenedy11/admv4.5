                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-primary"  onClick="javascript:submitIncluirNf({$id},'{$INTEGRAFIN}');">
                                <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span><span> Confirmar</span></button>
                        </li>
                        <li><button type="button" class="btn btn-danger"  onClick="javascript:submitVoltarPag('');">
                                ...
                                <table id="datatable-buttons-1" class="table table-bordered jambo_table">
                                    <thead>
                                        <tr style="background: gray; color: white;">
                                            ...
                                            <th>Obs</th>
                                            <td style="width: 20px;"> <button type="button" class="btn btn-success btn-xs" onClick="javascript:addParcelas({$id},{$numParcelaAdd});"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button> </td>
                                            <td style="width: 20px;"> <button type="button" class="btn btn-warning btn-xs" onClick="javascript:addParcelas({$id},{$numParcelaAdd - 2});"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button> </td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        {section name=i loop=$fin}
                                            ...
                                            <tr>
                                                <td> {$fin[i].PARCELA} </td>
                                                <td> 
                                                    <input {if $fin[i].SITPGTO eq 'B'} readonly {/if} class="form-control" type="text" id="venc" name="venc{$fin[i].PARCELA}" value={$fin[i].VENCIMENTO|date_format:"%d/%m/%Y"} >
                                                </td>
                                                <td> 
                                                    <input {if $fin[i].SITPGTO eq 'B'} readonly {/if} class="form-control" type="text" id="valor" name="valor{$fin[i].PARCELA}" value={$fin[i].VALOR|number_format:2:",":"."}>

                                                </td>
                                                <td>
                                                    <select {if $fin[i].SITPGTO eq 'B'} disabled {/if} id="idTipoDoc" name="tipo{$fin[i].PARCELA}" class="form-control">
                                                ...
                                                <td> 
                                                    {if $fin[i].SITPGTO eq 'B'} 
                                                        <input {if $fin[i].SITPGTO eq 'B'} readonly {/if} class="form-control" type="text" id="sitLanc" name="sitLanc{$fin[i].PARCELA}" value={$fin[i].SITPAG}>
                                                        
                                                    {else}
                                                        <select {if $fin[i].SITPGTO eq 'B'} readonly  {/if} id="idSitucao" name="situacao{$fin[i].PARCELA}" class="form-control">
                                                ...
                                                <td> 
                                                    ...
                                                    <input {if $fin[i].SITPGTO eq 'B'} readonly {/if} class="form-control" type="text" id="obs" name="obs{$fin[i].PARCELA}" value={$fin[i].OBS}>
