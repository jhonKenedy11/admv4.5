                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2 ">
                            ...
                            <div class="panel panel-default left_col">
                                <input class="form-control" type="text" id="credito" name="credito" readonly value={$credito}>
                            </div>
                        </div>
                        {/if}
                                    ...
                                    <tbody>
                                        ...
                                        {section name=i loop=$fin}
                                            ...
                                            <tr id="dados_financeiro" >
                                                ...
                                                <td> 
                                                    <input {if $fin[i].SITPGTO eq "B"} disabled {elseif $fin[i]['TIPODOCTO_ID'] <> "N"} enabled {else} disabled {/if} class="form-control" type="text" id="valor" name="valor{$fin[i].PARCELA}" value={$fin[i].VALOR|number_format:2:",":"."}>
