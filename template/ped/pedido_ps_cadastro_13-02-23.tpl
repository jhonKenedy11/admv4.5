                    ...
                    <div class="x_panel">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <button {if $id eq ''} disabled {/if} id="btnDuplicarPedido" type="button"
                                                ...
                                                onClick="javascript:submitDuplicarPedido({$id});"><span>Duplicar
                                                    Pedido</span></button>
                                        </li>
                                        <li>
                                            <button {if $id eq ''} disabled {/if} id="btnGerarOs" type="button"
                                                class="btn btn-primary btn-xs"
                                                onClick="javascript:submitGerarOs({$id});"><span> Gerar
                                                    OS</span></button>
                                        </li>
                                        <li>
                                            <button {if $id eq ''} disabled {/if} id="btnEstornarOs" type="button"
                                                class="btn btn-danger btn-xs"
                                                onClick="javascript:submitEstornarOs({$id});"><span> Estornar
                                                    OS</span></button>
                                        </li>
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group line-formated">
                                ...
                                <div class="col-lg-5 col-sm-6 col-xs-6 text-left line-formated">
                            ...
                            <div id="divTotal" class="form-group line-formated">
                                ...
                                <div class="col-md-2 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control  input-sm" placeholder="Desconto." id="valorDesconto"
                                                ...
                                                <div class="form-group line-formated">
                                                    ...
                                                    <div class="col-md-5 col-sm-12 col-xs-12 small line-formated">
                                                        ...
                                                        <div class="input-group line-formated">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <button type="button" class="btn btn-primary btn-sm"
                                                                    onClick="javascript:abrir('{$pathCliente}/index.php?mod=est&form=produto&opcao=pesquisarpecas&from=pedido_ps', 'produto');">
                                        ...
                                        <table id="datatable-buttons-pecas" class="table table-bordered jambo_table">
                                            ...
                                            <tbody>
                                                {section name=i loop=$lancPesq}
                                                    <tr>
                                                        <td> {$lancPesq[i].ITEMESTOQUE} </td>
                                                        <td> {$lancPesq[i].ITEMFABRICANTE} </td>
                                                        <td> {$lancPesq[i].CODIGONOTA} </td>
                                                        <td> {$lancPesq[i].DESCRICAO} </td>
                                                        <td> {$lancPesq[i].QTSOLICITADA|number_format:2:",":"."} </td>
                                                        <td> {$lancPesq[i].UNITARIO|number_format:2:",":"."} </td>
                                                        <td> {$lancPesq[i].DESCONTO|number_format:2:",":"."} </td>
                                                        <td> {$lancPesq[i].PERCDESCONTO|number_format:2:",":"."} </td>
                                                        <td> {$lancPesq[i].TOTAL|number_format:2:",":"."} </td>
                                                        <td>
                                            ...
                                            <div class="form-group line-formated">
                                                ...
                                                <div class="col-md-3 small col-sm-12 col-xs-12 has-feedback">
                                                    ...
                                                    <input class="form-control input-sm" readonly type="text"
                                                        ...
                                                        placeholder="Total Produto" value={$totalServico}>
                                                </div>
                                                <div class="col-md-1 col-sm-12 col-xs-12 has-feedback">
                                                </div>
                                                <div class="col-md-1 col-sm-12 col-xs-12 has-feedback">
                                            ...
                                            <div class="form-group line-formated">
                                                ...
                                                <div class="col-md-2 col-sm-6 col-xs-6">
                                                    ...
                                                    <input class="form-control input-sm" placeholder="Data de Abertura."
                                                        ...
                                                        title="Data de Abertura" alt="Data de Abertura"
                                                ...
                                                <div class="col-md-2 col-sm-6 col-xs-6">
                                                    ...
                                                    <input class="form-control input-sm"
                                                        placeholder="Data de Fechamento." id="dataFechamentoEnd"
                                                        data-inputmask="'mask': '99/99/9999'" title="Data de Fechamento"
                                                        alt="Data de Fechamento" name="dataFechamentoEnd"
                                                        value="{$dataFechamentoEnd}">
                                                </div>
                                                <div class="col-md-2 col-sm-6 col-xs-6">
                                                    <label for="prazoEntrega">Prazo Entrega OS</label>
                                                    <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                                    <input class="form-control input-sm"
                                                        placeholder="Prazo de Entrega Os." id="prazoEntregaOs"
                                            ...
                                            <div class="form-group line-formated">
                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <textarea class="resizable_textarea form-control input-sm"
                                                        id="obsOs" name="obsOs" rows="2">{$obsOs}</textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-6">
