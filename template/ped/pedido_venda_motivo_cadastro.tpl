...
<script type="text/javascript" src="{$pathJs}/ped/s_pedido_venda_motivo.js"> </script>
<!-- page content -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              {if $subMenu neq "cadastrar"}  {* Exibe apenas para alteração *}
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-3" for="motivo">
                    Motivo<span class="required">*</span>
                  </label>
                  <div class="col-md-2 col-sm-6 col-xs-12">
                    <input class="form-control" type="text" required id="motivo" 
                       name="motivo" readonly value="{$motivo}">
                  </div>
                </div>
                {/if}
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="descricao">Descri&ccedil;&atilde;o <span
                    class="required">*</span>
                </label>
