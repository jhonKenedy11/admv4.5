      ...
      <div class="right_col" role="main">
            <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2>
                                    <strong>PEDIDO VENDAS</strong><br>
                                                                  ...
                                                                  <tbody>
                                                                        ...
                                                                        {section name=i loop=$pedido}
                                                                              ...
                                                                              {if $pedido[i].EMISSAO neq $dia }
                                                                                    {if $dia neq ""}
                                                                                          <tr>
                                                                                                ...
                                                                                                <td colspan="2">
                                                                                                      <h6 class="pull-right">TOTAL DO DIA
                                                                                                      </h6>
                                                                                                </td>
                                                                                                {if $tipoUsuario neq ""}<td>
                                                                                                            <h6>R$ {$totalDiaCusto|number_format:2:",":"."}
                                                                                                            </h6>
                                                                                                </td>{/if}
                                                                                                <td colspan="2">
                                                                                                      <h6 class="pull-right">R$
                                                                              ...
                                                                              <tr class="trTotal">
                                                                                    ...
                                                                                    {if $tipoUsuario neq ""}
                                                                                          <td>
                                                                                                <h6>R$ {$totalCusto|number_format:2:",":"."}
                                                                                                </h6>
                                                                                          </td>
                                                                                    {/if}
                                                                                    <td colspan="2">
                                                                                          <h6 class="pull-right"><b>R$
...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            link.download = 'Pedido_Vendas_{$dataIni}_a_{$dataFim}.csv';
            link.click();
      }
</script>
<!-- /page content -->