            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">                        
                        ...
                        {if $sistema eq "PECAS"} 
                            ...
                            <li><button
                                type="button" class="btn btn-warning"  onClick="javascript:atualizarInfo();">
                            ...
                            {/if}
                            <li><button type="button" class="btn btn-success"  onClick="javascript:submitDigitacao('');">
                                    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span><span> Voltar</span></button>
                            </li>
                        {else}
                        {if $esconderbtn eq "N"}
                            <li>
                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modalCC" onclick="javascript:setaDadosPedido()"><span span  aria-hidden="true" data-toggle="tooltip">C.C.</span></button>
                            </li> 


                            <li><button {if $situacao neq 10} style="display:none" {/if}
                            type="button" class="btn btn-primary"  onClick="javascript:submitAprovado('');">
                            ...
                            {if $validarDescontoGeral == 'S' }
                                <li>
                                    <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAutoriza">
                                    <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span><span> Cotação</span></button>
                                </li>                              
                                <li>
                                    <button  type="button" class="btn btn-success" data-toggle="modal" data-target="#AutorizarPedido">
                           ...
                           {else}
                                <li><button 
                                    ...
                                    {else if $situacao eq 12}
                                        style=" display:none"
                                    {/if}
                                    type="button" class="btn btn-primary"  onClick="javascript:submitConfirmarSmart('');">
                                        <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span><span> Cotação</span></button>
                                </li>
                                <li><button 
                                    {if $situacao eq 10}
                                    ...
                                    onClick="javascript:submitCadastrarPedido();">
                                        <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span><span> Pedido</span></button>
                                </li>
                            {/if}  
                            <li><button
                                type="button" class="btn btn-warning"  onClick="javascript:atualizarInfo();">
                        ...
                        <li><button {if (($situacao != 6) and (!$validaAlterarPedido)) } style="display:none" {/if} type="button" class="btn btn-primary"  
                        ...
                        <li><button type="button" class="btn btn-danger"  onClick="javascript:submitDigitacao('');">
                                <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span><span> Voltar</span></button>
                        </li>
                        {if $consulta eq "C"}
                  ...
                  <div class="x_content">
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                ...
                                <div class="input-group">
                                    <div class="panel panel-default small">
                                    <select name="condPgto" class="js-example-basic-single form-control" name="condPgto" id="condPgto">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <label for="centroCusto" >
                                    <h2>Centro de Custo Entrega</h2>
                                </label>
                                <div class="panel panel-default small">
                                    <select name="centroCustoEntrega" class="form-control">
                    ...
                    <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-6 col-xs-6">
                                    ...
                                    <input class="form-control" placeholder="Data de Emissão." id="emissao" 
                                            name="emissao" value="{$emissao}">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-4">
                                    <label for="prazoEntrega">Entrega</label>
                                    <input class="form-control" placeholder="Prazo de Entrega." id="prazoEntrega" 
                                    ...
                                    <input 
                                       {if $adicionadoItem eq 'S'}
                                        ...
                                        {else}    
                                            enable 
                                        {/if}
                                        class="form-control money" type="text"  id="frete" name="frete" placeholder="digite o valor do frete" value={$frete}>
                                </div>
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <input
                                       {if $digitarDesconto eq 'N'}
                                        ...
                                        {else if $situacao == 6}
                                            disabled
                                        {/if}
                                        class="form-control money" type="text"  id="desconto" name="desconto"  placeholder="Desconto Geral" value={$desconto}>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-4">
                                    ...
                                    <input 
                                       ...
                                       {else}    
                                            enable 
                                       {/if}
                                       class="form-control money" type="text"  id="despAcessorias" name="despAcessorias" placeholder="Despesas acessórias" value={$despAcessorias}>
                                </div>  
                            </div>
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-4 col-xs-4 text-left">
                        ...
                        <div class="form-group">
                            <input 
                                ...
                                {else}
                                    disabled
                                {/if}
                            class="form-control" placeholder="Digite a localização do produto para pesquisar." id="pesLocalizacao" 
                    ...
                    <div class="col-lg-1 col-sm-1 col-xs-1 text-left">  
                        ...
                        {else}
                            disabled
                        {/if}
                        type="button" class="btn btn-warning btm-sm"  onClick="javascript:submitBuscar('');">
                        ...
                        <tbody>
                            ...
                            {section name=i loop=$lancPesq}
                                ...
                                <tr>
                                    ...
                                    <td id="promo" name="promo" style="padding-top: 15px;"> {$lancPesq[i].PROMOCAO|number_format:2:",":"."} </td>
                                    <!--
                                    <td align=right> 
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons2" class="table table-condensed table-responsive small">
                        ...
                        <tbody id="bodyMotivo">
                            {section name=i loop=$lancItens}
                                {assign var="total" value=$total+1}
                                <tr style="height: 50px;" {if ($lancItens[i].PRECOMINIMO > $lancItens[i].UNITARIO) and ($situacao == 10)}style="color:orange"{/if}>{if ($exibirmotivo == 'S')}
                                    <td>
                                    ...
                                    {if $sistema != "PECAS"} 
                                        ...
                                        {/if}
                                        <td style="width:5px">
                                            <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" onclick="editar(this, {$lancItens[i].ID}, {$lancItens[i].NRITEM}, {$lancItens[i].PERCDESCONTO} )" data-target="#modalInutiliza"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span></button>
                                        </td>
                                    ...
                                    {else}
                                        ...
                                        {/if}
                                        <td style="width:5px">
                                            <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" onclick="editar(this, {$lancItens[i].ID}, {$lancItens[i].NRITEM} )" data-target="#modalInutiliza"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span></button>
                                        </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="col-md-2">
                                ...
                                <input Readonly class="form-control" type="text" id="nritem" name="nritem" value={$nritem}>
                            </div>
                            <div class="col-md-3">
                                <label for="codigo">Codigo</label>
                                <input Readonly class="form-control" type="text" id="codigo" name="codigo">
                            </div>
                            <div class="col-md-7">
                            ...
                            <div class="col-md-2">
                                ...
                                <input Readonly class="form-control" type="text" id="quantidade" name="quantidade">
                            </div>
                            
                            <div class="col-md-2">
                                <label for="unitario">Unitario</label>
                                <input Readonly class="form-control" type="text" id="unitario" name="unitario">
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input Readonly class="form-control" type="text" id="totalitem" name="totalitem">
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:atualizaCustoNovo({$id}, nritem.value, custo.value, totalitem.value, quantidade.value, descricao.value, codigo.value, estoque.checked, descontoItem.value, percDescontoItem.value );">Confirma</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    </div>
                </div>
            </div>
    ...
    function editar(e, id, nritem, percDesc, descricao){
        ...
        var desconto = linha.find("td:eq(5)").text().trim();
        var totalitem = linha.find("td:eq(6)").text().trim();
        {if ($permiteAlterarCusto == "S") } 
          var custo = linha.find("td:eq(7)").text().trim();  
        {else}
          var custo = 0.00;
        {/if} 
        percDesconto == '' ?  percDesconto = 0 :  percDesconto = percDesc;
