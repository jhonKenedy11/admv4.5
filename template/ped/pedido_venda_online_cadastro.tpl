    <script type="text/javascript" src="{$pathJs}/ped/s_pedido_venda_online.js"> </script>
        <!-- page content -->
        ...
        <form id="lancamento" data-parsley-validate  class="form-horizontal form-label-left" NAME="lancamento"  ACTION="{$SCRIPT_NAME}" METHOD="post">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <li><button type="button" class="btn btn-danger" onClick="javascript:submitDigitacao('');">
                                <span class="glyphicon glyphicon-backward" style="color:#fff;" aria-hidden="true"></span> Voltar
                            </button>
                        </li>
                        <li><button type="button" class="btn btn-primary" onClick="javascript:submitConfirmar('');">
                                <span class="glyphicon glyphicon-floppy-save" style="color:#fff;" aria-hidden="true"></span> Concluir 
                            </button>
                        </li>
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1 text-left">
                    <label></label>                        
                    <button type="button" class="btn btn-warning"  onClick="javascript:submitBuscar('');">
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><button type="button" class="btn btn-small btn-link" onClick="javascript:submitVoltar('');">
                        ...
                        <li>
                            <button type="button" class="btn btn-success" onClick="submitTodosEmLinha({$id});">
                                <span class="glyphicon glyphicon-list" style="color:#fff;" aria-hidden="true"></span><span style="color:#fff;"> Todos em Linha</span>
                            </button>
                        </li>
                      <li>
                        {if $kit eq "2"}
                                ...
                                {/if} 
                                    ...
                                    <td style="width: 125px;" class="input-group">
                                        ...
                                        <input class="form-control input-sm" min="1" step="1" type="number"
                                            title="Digite a qtde para este item." id="quant{$lancPesq[i].CODIGO}" name="quant{$lancPesq[i].CODIGO}">
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-small btn-link btn-mini" 
                                                onClick="ajaxIncluirItemQuantUnico({$lancPesq[i].CODIGO}, this);">
                                    ...
                                    <td>
                                        <span style="font-weight:bold;"> 
                                            {$lancPesq[i].DESCRICAO} 
                                        </span>
                                    </td>
                                    <td class="price-value" style="text-align:center;">
                                        <span style="font-weight:bold;">
                                            {$lancPesq[i].VENDA|number_format:2:",":"."} 
                                        </span>
                                    </td>
                                    <td class="price-value" style="text-align:center;"> 
                                        <span style="font-weight:bold;">
                                            {$lancPesq[i].PROMOCAO|number_format:2:",":"."} 
                                        </span>
                                    </td>
                                    <td class="estoque-col" style="text-align:center;">
                                        {if isset($lancPesq[i].QUANTIDADE) && $lancPesq[i].QUANTIDADE == 0}
                                            <button type="button" class="btn btn-xs btn-primary glyphicon glyphicon-eye-close" text-align="center"
                                                id="btnAtualizaEstoque{$lancPesq[i].CODIGO}" 
                                                onclick="ajaxAtualizarEstoque({$lancPesq[i].CODIGO}, this)">
                                                
                                            </button>
                                            <span id="estoque{$lancPesq[i].CODIGO}" style="display:none;">0</span>
                                        {else}
                                            <span id="estoque{$lancPesq[i].CODIGO}" class="estoque-info" style="font-weight:bold;">
                                                {$lancPesq[i].QUANTIDADE|default:"-"}
                                            </span>
                                        {/if}
                                    </td>
                                </tr>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <h2 id="totalPedidoValor">TOTAL: {$totalPedido|number_format:2:",":"."}</h2>
                        </li>
                    </ul>
                    <!--ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up fa-2x"></i></a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="carrinho" class="table table-striped table-condensed table-responsive small">
                        <thead>
                            <tr>
                                <th>Ref.</th>
                                <th>Descrição</th>
                        ...
                        <tbody>
                            {section name=i loop=$lancItens}
                                ...
                                <tr>
                                    ...
                                    <td> <button type="button" class="btn btn-danger btn-xs" onClick="ajaxExcluirItem({$lancItens[i].ID}, {$lancItens[i].NRITEM}, this);">
                                            <span class="glyphicon glyphicon-remove" text-align="center" aria-hidden="true"></span></button> </td>
                                </tr>
                            <p>
                            {/section} 
