            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default small">                                               
                        <textarea class="resizable_textarea form-control" id="desc_cc_modal" name="desc_cc" rows="4" placeholder="Formato: [Código ou Descrição] - [Quantidade]">{$desc_cc}</textarea>
                    </div>
                </div>    
            </div>
            <div class="x_panel">   
