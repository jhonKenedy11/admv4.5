            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:atualizaCustoNovo({$id}, nritem.value, custo.value, totalItem.value, quantidade.value, descricao.value, codigo.value, estoque.checked, descontoItem.value, percDescontoItem.value, unitario.value );">Confirma</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                    </div>
                </div>
            </div>
    ...
    function editar(e, id, nritem, percDesc, descricao){
        ...
        {if ($permiteAlterarCusto == "S") } 
          var custo = linha.find("td:eq(8)").text().trim();  
        {else}
          var custo = 0.00;
        {/if} 
