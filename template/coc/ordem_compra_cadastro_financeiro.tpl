            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            {* <h2>
                                Cadastro de financeiro e nota fiscal
                                {if $mensagem neq ''}
                            ...
                            <div class="">
                                <div class="col-md-8 title-pedido-servico" style="padding-left: 0;">
                                    <h2 class="title-cadastro_">Ordem de compra - <b>Cadastro de financeiro e nota fiscal</b></h2>
                                </div>
                            </div>

                            <ul class="nav navbar-right panel_toolbox">
                                <li><button type="button" class="btn btn-primary"
                                        onClick="javascript:submitCadastraNf({$id});">
                        ...
                        <div class="x_content small">
                            <div class="row">
                                <h5>
                                    <div class="col-md-2 col-sm-2 col-xs-2">
                                        ...
                                        <input maxlength="11" type="text" class="form-control" id="numNf" name="numNf"
                                            value="{$numNf}">
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-3  has-feedback">
                                        ...
                                        <input class="form-control has-feedback-left" type="text" id="dataEntrada"
                                            name="dataEntrada" style="text-align: center;" value={$dataEntrada}
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-2">
                                        ...
                                        <input type="text" style="text-align: center;" class="form-control" id="data" name="data" disabled
                                            value="{$data}">
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-2">
                                        <label for="condPgto">Cond. de Pagamento</label>
                                        <select name="condPgto" class="form-control" style="text-align: center;"
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-xs-5">
                                    ...
                                    <input type="text" class="form-control" id="clienteNome" name="clienteNome" disabled
                                        value="{$clienteNome}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-xs-5">
                                    ...
                                    <input maxlength="44" class="form-control" size="50px" type="text"
                                        name="nfeReferenciada" value={$nfeReferenciada}>
                                </div>

                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <label for="basest">Base ST</label>
                                    <input type="text" class="form-control money" id="basest" name="basest"
                                        value="{$basest}">
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3  has-feedback">
                                    ...
                                    <input class="form-control has-feedback-left" type="text" id="dataEmissao"
                                        name="dataEmissao" required="required" style="text-align: center;" value={$dataEmissao}
                                        data-inputmask="'mask': '99/99/9999'">
                            ...
                            <div class="x_panel" style="padding: 5px;">
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation"><a href="#tab_content2" id="itens-tab" role="tab"
                                                data-toggle="tab" aria-expanded="true">Itens</a>
                                        </li>
                                        <li role="presentation"><a href="#tab_content3" id="obs-tab" role="tab"
                                                data-toggle="tab" aria-expanded="true">Observações</a>
                                        </li>
                                    </ul>
                                                ...
                                                <table id="datatable-buttons-1"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        {section name=i loop=$fin}
                                                            ...
                                                            <tr>
                                                                <td style="padding:4px; text-align:center; "> {$fin[i].PARCELA} </td>
                                                                <td>
                                                                    <input class="form-control" type="text" id="venc"
                                                                        name="venc{$fin[i].PARCELA}" style=" width: 95px; padding:4px; text-align:center;"
                                                                        value={$fin[i].VENCIMENTO|date_format:"%d/%m/%Y"}>
                                                                </td>
                                                                <td>
                                                                    <input class="form-control money" type="text" id="valor"
                                                                        name="valor{$fin[i].PARCELA}" style=" width: 95px; padding:4px;"
                                                                        value={$fin[i].VALOR|number_format:2:",":"."}>
                                                                ...
                                                                <td>
                                                                    <select id="idSitucao" name="situacao{$fin[i].PARCELA}"
                                                                        class="form-control" style="padding:2px;">>
                                                                        {html_options values=$situacaoLanc_ids selected=$situacaoLanc_id output=$situacaoLanc_names}
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="padding:0;" type="text" id="obs" name="obs{$fin[i].PARCELA}" value={$fin[i].OBS}>
                                                                </td>
                                                            </tr>
                                                            <p>
                                                            {/section}
                                                    ...
                                                    <tbody>
                                                        {section name=i loop=$lancItens}
                                                            <tr>
                                                                ...
                                                                <td> {$lancItens[i].QTSOLICITADA|number_format:2:",":"."}
                                                                </td>
                                                                <td> {$lancItens[i].UNITARIO|number_format:2:",":"."} </td>
                                                                <td> {$lancItens[i].TOTAL|number_format:2:",":"."} </td>
                                                                <td><input class="form-control" type="text" id="cfop"
                                                                        name="cfop{$lancItens[i].NRITEM}" value={5102}
                                                                        maxlength=4></td>
                                                                <td><input class="form-control" type="text" id="tribicms"
                                                                        name="tribicms{$lancItens[i].NRITEM}" value={"000"}
                                                                        maxlength=3></td>
                                                                <td><input class="form-control money" type="text"
                                                                        id="aliqipi" name="aliqipi{$lancItens[i].NRITEM}"
                                                                        value={0|number_format:2:",":"."}></td>
                                                                <td><input class="form-control money" type="text" id="ipi"
                                                                        name="ipi{$lancItens[i].NRITEM}"
                                                                        value={0|number_format:2:",":"."}></td>
                                                            </tr>
                                                            <p>
                                                            {/section}
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var campo = document.getElementById('serie');
        campo.addEventListener('input', function() {
            limitarCaracteres(this, 3);
        });
    });

    document.addEventListener('DOMContentLoaded', function() {
        var campo = document.getElementById('numNf');
        campo.addEventListener('input', function() {
            limitarCaracteres(this, 11);
        });
    });
