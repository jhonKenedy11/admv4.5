            ...
            <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <button {if $ocBaixado eq true} disabled {/if} type="button" class="btn btn-primary"  onClick="javascript:submitConfirmarSmart('');">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
                            <ul class="dropdown-menu" role="menu">
                               <li>
                                    <button {if $id eq ''} disabled {/if} type="button" class="btn btn-primary btn-xs" onClick="javascript:duplicaOrdemCompra('{$id}');"><span>Duplicar Ordem de Compra</span></button>
                               </li>
                            </ul>
                      </li>
                      <li>
                ...
                <div class="form-group line-formated">
                    <div class="col-md-6 col-sm-12 col-xs-12 line-formated">
                        ...
                        <div class="input-group line-formated">
                            ...
                            <span class="input-group-btn">
                                <button {if $ocBaixado eq true} disabled {/if} type="button" class="btn btn-primary btn-sm" 
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        ...
                        <select {if $ocBaixado eq true} disabled {/if} name="condPgto" class="form-control js-example-basic-single" id="condPgto">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-6 text-left line-formated">
                        ...
                        <div class="panel panel-default small line-formated">
                            <select {if $ocBaixado eq true} disabled {/if} name="situacaoCombo" class="form-control input-sm" id="situacaoCombo" readonly> 
                ...
                <div class="form-group line-formated">
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-6 small text-left">
                        <label>Serie</label>
                        <div class="form-group">
                            <input {if $ocBaixado eq true} readonly {/if} class="form-control input-sm" placeholder="Serie Nf." id="serie" 
                                name="serie" value="{$serie}" maxlength="3"
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-6 small text-left">
                        ...
                        <div class="form-group">
                            <input {if $ocBaixado eq true} readonly {/if} class="form-control input-sm" placeholder="Data Emissao." id="dataEmissao" 
                                name="dataEmissao" value="{$dataEmissao}" data-inputmask="'mask': '99/99/9999'"
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 small">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control input-sm money" type="money" maxlength="10" name="frete" onblur="javascript:atualizaTotais()"
                         value={$frete}>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-6 small">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control input-sm money" type="money" maxlength="10" name="despacessorias" onblur="javascript:atualizaTotais()"
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 small">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control input-sm money" type="money" maxlength="10" name="seguro" onblur="javascript:atualizaTotais()"
                         value={$seguro}>
                    </div>  
                </div>
                ...
                <div class="form-group line-formated">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <textarea {if $ocBaixado eq true} readonly {/if} class="resizable_textarea form-control input-sm" id="obs" name="obs" rows="2" >{$obs}</textarea>
                    </div>  
                </div>
                <div class="form-group line-formated" id="div_busca_prod">
                    ...
                    <div class="form-group line-formated">
                        ...
                        <div class="col-md-5 small col-sm-12 col-xs-12 line-formated">
                            ...
                            <div class="input-group line-formated">
                                <input type="text" class="form-control input-sm" readonly id="descProduto" name="descProduto" placeholder="Produto" required
                                    value="{$descProduto}" >
                    ...
                    <div class="form-group line-formated">
                        <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                            ...
                            <input class="form-control input-sm money" type="text" id="quant" 
                                name="quant" placeholder="Quantidade"  alt="Quantidade" 
                                onchange="javascript:calculaTotalItens('')"
                                value={$quant}>
                        </div>
                        <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                        <label for="vlrUnitarioPecas">Valor Unitário</label>
                        <input class="form-control input-sm money" type="text" id="unitario" 
                            name="unitario" placeholder="Valor Unitário" alt="Valor Unitário" 
                            onchange="javascript:calculaTotalItens('')"
                            value={$unitario}>
                        </div>
                        <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                        ...
                        <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                            ...
                            <input class="form-control input-sm money" type="text" id="vlrDesconto" 
                                ...
                                onchange="javascript:calculaTotalItens('desconto')"
                                value={$vlrDesconto}
                                >
                        </div>
                        <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                            <label for="totalPecas">T O T A L</label>
                            <input class="form-control input-sm" readonly type="text" id="totalItem" tabindex="-1" 
                                name="totalItem" placeholder="0,00" value={$totalItem}>
                        </div>
                        <div class="col-md-1 col-sm-12 col-xs-12 has-feedback">
                            <label style="visibility:hidden">btn</label>
                            <button {if $ocBaixado eq true} disabled {/if} type="button" class="btn btn-success btn-sm"  onClick="javascript:submitConfirmarPecas();">
                        ...
                        <tbody>
                            {section name=i loop=$lancItens}
                                <tr>
                                    ...
                                    <td> 
                                        <button {if $lancItens[i].ITEMESTOQUE eq 0} disabled {/if}type="button" class="btn btn-info btn-xs" onclick="javascript:abrir('{$pathCliente}/index.php?mod=est&form=produto&opcao=pesquisarpecas&letra=||{$lancItens[i].ITEMFABRICANTE}||||{$lancItens[i].ITEMESTOQUE}', 'produto');" ><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button> 
                                        <button {if $ocBaixado eq true} disabled {/if} type="button" class="btn btn-primary btn-xs" onclick="javascript:editarItem(this, '{$lancItens[i].NRITEM}')" ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button> 
                                        <button {if $ocBaixado eq true} disabled {/if} type="button" class="btn btn-danger btn-xs" onclick="javascript:submitExcluiItem('{$lancItens[i].NRITEM}');"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button> 
                                    </td>
                                    </tr>
                                <p>
                            {/section} 
