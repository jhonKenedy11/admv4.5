                    ...
                    <div class="x_content">
                        <form id="lancamento" name="lancamento" data-parsley-validate METHOD="POST"
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                ...
                                <input class="form-control" id="numOrdemCompra" name="numOrdemCompra"
                                    placeholder="Número da ordem de compra." value={$numOrdemCompra}>
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <label>Número NF</label>
                                <input class="form-control" id="numDocto" name="numDocto" placeholder="Número NF."
                                    value={$numDocto}>
                            </div>
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div>
                                    <input type="text" name="dataConsulta" id="dataConsulta" class="form-control"
                                        style="text-align: center;" value="{$dataIni} - {$dataFim}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <select class="select2_multiple form-control" multiple="multiple" id="situacaoCombo"
                                        name="situacaoCombo" style="border-radius: 5px;">
            ...
            <div class="responsive">
                <div class="x_panel">
                    <table id="datatable-buttons" class="table table-bordered jambo_table">
                        ...
                        <thead>
                            <tr class="headings">
                                <th style="width: 20px;">O.C.</th>
                                <th style="width: 50px;">Emissão</th>
                                <th>Situação</th>
                                <th>Nº</th>
                                <th style="width: 20px;">Série</th>
                                <th>Cliente</th>
                                <th>CNPJ</th>
                        ...
                        <tbody>
                            ...
                            {section name=i loop=$lanc}
                                ...
                                <tr>
                                    ...
                                    <td align=center> {$lanc[i].TOTAL|number_format:2:",":"."} </td>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-xs"
                                            onClick="javascript:submitGerarNFC('{$lanc[i].ID}', '{$lanc[i].SITUACAO}');"><span
                                                class="glyphicon glyphicon-flag" aria-hidden="true" data-toggle="tooltip"
                                                title="Gerar NFC"></span></button>
                                        <button type="button" class="btn btn-info btn-xs"
                                            onclick="javascript:abrir('index.php?mod=coc&form=ordem_compra_imprime&opcao=imprimir&parm={$lanc[i].ID}');"><span
