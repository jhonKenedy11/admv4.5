...
<!--<script type="text/javascript" src="{$pathJs}/crm/s_atividade.js"> </script>-->
...
<div class="right_col" role="main">
  <div class="">
    ...
    <form id="lancamento" data-parsley-validate class="form-horizontal form-label-left" NAME="lancamento"
      ...
      <input name=form type=hidden value="atividade">
            ...
            <div class="x_title">
              <h2>
                {if $subMenu eq "cadastrar"}
                  Atividade - Cadastro
                {else}
                  Atividade - Altera&ccedil;&atilde;o
                {/if}
              </h2>
            ...
            <div class="x_content">
              ...
              <form class="container" novalidate="" action="/echo" method="POST" id="myForm">
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-3" for="id">Atividade</label>
                  <div class="col-md-2 col-sm-6 col-xs-12">
                    <input class="form-control" type="text" maxlength="4" required="true" id="id"
                      tittle="Preencha este campo com letras ou numeros, até 4 caracteres." name="id"
                      placeholder="Digite Atividade." value={$id}>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control" type="text" maxlength="30" required="true" id="descricao"
                      tittle="Preencha este campo com letras ou numeros, até 30 caracteres." name="descricao"
