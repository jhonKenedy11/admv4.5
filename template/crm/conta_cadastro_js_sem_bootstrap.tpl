...
<style>
    ...
    #tab_content1>.panel-body, 
    #tab_content2>.panel-body, 
    #tab_content3>.panel-body, 
    #tab_content4>.panel-body,
    #tab_content5>.panel-body,
    #tab_content6>.panel-body {
    ...
    .accordion-content {
        ...
        height: 0;
        overflow: hidden;
        transition: all 0.8s ease; /* Suaviza altura e opacidade */
    }
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                ...
                                <li><button type="button" class="btn btn-danger" onClick="javascript:submitVoltar('{$opcao}');">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control border-blue" 
                                        required="required" 
                                        maxlength="60"
                                        type="text" 
                                        id="nomeReduzido" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12 ">
                                    ...
                                    <input class="form-control" 
                                        ...
                                        title="Digite CNPJ/CPF somente numeros."
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control" 
                                        ...
                                        name="ieRg"
                                        placeholder="Digite somente numeros." 
                                        title="Digite o RG/IE somente numeros."
                                        value={$ieRg}>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control" 
                                        ...
                                        name="im"
                                        placeholder="Digite somente numeros." 
                                        title="Digite a IM somente numeros."
                                        value={$im}>
                                </div>
                            </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div id="accordion">
                            ...
                            <a href="javascript:void(0);" onclick="toggleAccordion('section1')">
                                <h4 class="panel-title">Dados Adicionais <i class="fa fa-chevron-down"></i></h4>
                            </a>
                            ...
                            <div id="section1" class="accordion-content" style="display: none;">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li class="accordion-button active" onclick="showTabContent(event, 'tab_content1')">
                                                <a href="#">Dados Clientes</a>
                                            </li>
                                            <li class="accordion-button" onclick="showTabContent(event, 'tab_content2')">
                                                <a href="#">Créditos</a>
                                            </li>
                                            <li class="accordion-button" onclick="showTabContent(event, 'tab_content3')">
                                                <a href="#">Ponto Referência</a>
                                            </li>
                                            <li class="accordion-button" onclick="showTabContent(event, 'tab_content4')">
                                                <a href="#">Tributos</a>
                                            </li>
                                            <li class="accordion-button" onclick="showTabContent(event, 'tab_content5')">
                                                <a href="#">Pedidos</a>
                                            </li>
                                            <li class="accordion-button" onclick="showTabContent(event, 'tab_content6')">
                                                <a href="#">Endereços entrega</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    </div> <!--FIM id="tab_content1" -->


                                    <div role="tabpanel" class="tab-pane small" id="tab_content2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        {section name=i loop=$credito}
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:submitExcluirCredito('{$credito[i].ID}');">
                                    ...
                                    </div> <!-- FIM id="tab_content2"" -->

                                    <div role="tabpanel" class="tab-pane small" id="tab_content3" aria-labelledby="profile-tab">
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea class="resizable_textarea form-control" id="referencia"  name="referencia" rows="3">
                                                            {$referencia}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea class="resizable_textarea form-control" id="transversal1" name="transversal1" rows="3">
                                                            {$transversal1}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea class="resizable_textarea form-control" id="transversal2" name="transversal2" rows="3">
                                                            {$transversal2}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-2 col-sm-12 col-xs-12">
                                                        ...
                                                        <select class="form-control" 
                                                            name="regimeEspecialST"
                                                            id="regimeEspecialST" 
                                                            title="Regime especial ST.">
                                                    ...
                                                    <div class="col-md-2 col-sm-12 col-xs-12">
                                                        ...
                                                        <select class="form-control" 
                                                            name="regimeEspecialSTMT"
                                                            id="regimeEspecialSTMT" 
                                                            title="Regime especial ST MT.">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea class="resizable_textarea form-control" id="regimeEspecialSTMsg"  name="regimeEspecialSTMsg" rows="3">
                                                            {$regimeEspecialSTMsg}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        {section name=i loop=$lancPedidos}
                                                            <tr>
                                                                ...
                                                                <td> {$lancPedidos[i].EMISSAO|date_format:"%d/%m/%Y"} </td>
                                                                ...
                                                                <td id="tdAddBns">
                                                                    ...
                                                                    <button {if $permiteIncluirBonus neq true} disabled
                                                                        ...
                                                                        <span class="glyphicon glyphicon-plus glyphiconAdd"
                                                                            aria-hidden="true"></span>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade small" id="tab_content6" aria-labelledby="profile-tab">
                                        <div class="panel-body">
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <table id="datatable-address" class="table table-bordered jambo_table col-md-8">
                                                    ...
                                                    <tbody>
                                                        {section name=k loop=$deliveryAddress}
                                                            <tr>
                                                                <td name="addressTitulo"> {$deliveryAddress[k].TITULOEND}
                                                                </td>
                                                                <td name="addressEndereco"> {$deliveryAddress[k].ENDERECO}
                                                                </td>
                                                                <td name="addressNumero"> {$deliveryAddress[k].NUMERO} </td>
                                                                <td name="addressBairro"> {$deliveryAddress[k].BAIRRO} </td>
                                                                <td name="addressNumero"> {$deliveryAddress[k].CIDADE} </td>
                                                                <td name="addressNumero"> {$deliveryAddress[k].UF} </td>
                                                                <td name="addressNumero"> {$deliveryAddress[k].FONE} </td>
                                                                <td name="addressStatus"> {$deliveryAddress[k].STATUS} </td>
                                                                <td>
