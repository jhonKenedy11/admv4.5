                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-warning" data-target="#myModal">
                                <span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span><span> Calendario</span>
                            </button>
                        </li>
                ...
                <form class="full" NAME="lancamento" METHOD="POST" class="form-horizontal form-label-left" novalidate ACTION={$SCRIPT_NAME} >
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        ...
                        <div class="panel panel-default">
                            <input class="form-control" type="tel" id="pesPedido" name="pesPedido" value={$pesPedido} >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-left">
                            ...
                            <div class="panel panel-default">
                                <SELECT {if ($verTodosVend == false)}
                                            enable
                                        {else}
                                            disable tabindex="-1" aria-disabled="true" readonly
                                        {/if}
