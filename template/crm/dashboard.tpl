    ...
    <!--COMBOS PESQUISAS -->
        <div class="row col-md-12 col-sm-12">
          ...
          <div class="form-group col-md-4 col-sm-12 col-xs-12">
            ...
            <SELECT {if ($vertodoslancamentos == true )}
                            enable
                        {else}
                            disabled
                    {/if}
          ...
          <div class="form-group col-md-1 col-sm-12 col-xs-12">
            ...
            <button type="button" class="btn" id="btnSubLet" onClick="javascript:submitLetra('');">
              <span class="glyphicon glyphicon-search" id="btnSubLetPes aria-hidden="true"></span><span> Pesquisa</span>
            </button>
          </div>
          
        </div> <!--FIM COMBOS PESQUISAS -->
        ...
        <div class="x_panel tile" id="acomp">
          <div class="x_title">
            ...
            <button  type="button" class="btn btn-success btn-xs pull-right" id="calendar"
                ...
                <span class="glyphicon glyphicon-calendar calendar" aria-hidden="true" data-toggle="tooltip" title="Visualizar Calendário"></span>
            </button>
            <button  type="button" class="btn btn-success btn-xs pull-right" id="btnAddAcomp"
                onclick="javascript:abrirAcompanhamento('');">
                <span class="glyphicon fa fa-plus-circle" aria-hidden="true" data-toggle="tooltip" title="Adicionar Acompanhamento"></span>
            </button>
            <div class="clearfix"></div>
          </div>
          <h4> </h4>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <textarea name="obsPerda" id="obsPerda" class="form-control" rows="3" placeholder="Informe o detalhe ou observação da perda do pedido (opcional)">{$obsPerda|default:''}</textarea>
                </div>
