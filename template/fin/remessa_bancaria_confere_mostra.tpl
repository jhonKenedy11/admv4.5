            ...
            <div class="x_panel">
              <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                  <li><button type="button" class="btn btn-warning" onClick="javascript:submitRemessaConfere();">
              ...
              <div class="x_content">
                <form id="retorno" name="retorno" data-parsley-validate METHOD="POST"
                  ...
                  <div class="form-group col-md-2 col-sm-4 col-xs-4">
                    <label class="">Selecine o arquivo de Remessa</label>
                  </div>
                  ...
                  <tbody>
                    ...
                    {section name=i loop=$lanc}
                      ...
                      <tr class="even pointer info">
                        ...
                        <td align=right>{$lanc[i].valorFinanceiro|number_format:2:",":"."} </td>
