<style>
  ...
  .values-debito {
    ...
    /* Divide a div em duas partes */
    width: 100%;
    margin-top: 10px;
    /* Espaçamento superior para distanciar dos spans */
  }
      ...
      <div class="row">
                ...
                <div class="row col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group col-md-2 col-sm-2 col-xs-2">
                    ...
                    <i class="glyphicon glyphicon-calendar fa fa-calendar"
                      style="position: absolute; top: 10%; transform: translateY(-20%);"></i>
                  ...
                  <div class="form-group col-md-1 col-sm-1 col-xs-1">
                    <button type="button" id="btnpesquisa" class="btn btn-primary pull-right"
        ...
        <div class="row col-md-12 col-sm-12" style="display: inline-block;">
          <div class="tile_count">
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              ...
              <div class="count green" id="total_periodo_debito">0,00</div>
            </div>
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i>Total Crédito Periodo</span>
              <div class="count" id="total_periodo_credito">0,00</div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="x_panel tile saldosbancarios overflow_hidden">
              <div class="x_title">
                ...
                <table class="" style="width:100%">
                  <tr>
                    ...
                    <th>
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-5 ">
                        <p class="text-center">Percentual</p>
                      </div>
                    </th>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <table class="tile_info">
                        <tr>
                          <td class="pull-left">
                            <p><i class="fa fa-square red"></i>Dados não localizados </p>
                          </td>
                          <td>
                            <p class="nameContas">100%</p>
                          </td>
                          <td class="pull-right">
                          </td>
                        </tr>
          ...
          <div class="col-md-6 col-sm-6 ">
            <div class="x_panel tile lancAbertoBaixado fixed_height_420">
              <div class="x_title">
                <h2>Lançamentos aberto/baixado</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <div class="dashboard-widget-content">
                  <div class="sidebar-widget">
                    ...
                    <div class="goal-wrapper">
                      ...
                      <div class="values-debito">
                        <span class="right-debito-aberto" id="right-debito-aberto">0.00</span>
                        <span class="left-debito-baixado" id="left-debito-baixado">0.00</span>
                      </div>
                    </div>
                  ...
                  <div class="sidebar-widget">
                    ...
                    <div class="goal-wrapper">
                      ...
                      <span class="gauge-value pull-left">%</span>
                      <span id="goal-text" class="goal-value pull-right">100%</span>
                      <div class="values-credito">
                        <span class="right-credito-aberto" id="right-credito-aberto">0.00</span>
                        <span class="left-credito-baixado" id="left-credito-baixado">0.00</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12  widget_tally_box">
            <div class="x_panel resumoCentroCusto">
              <div class="x_title">
                <h2>Resumo Centro de Custo</h2>

                <div class="clearfix"></div>
              </div>
              <div class="x_content x_contentResumo">


                <div id="graph_bar" style="width:100%;height: 30rem !important;"></div>
