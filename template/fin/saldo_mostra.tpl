        ...
        <div class="">
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Saldo Banc&aacute;rio - Consulta</h2>
                    {include file="../bib/msg.tpl"}
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-warning"  onClick="javascript:submitPesquisar();">
                  ...
                  <div class="x_content">
                        ...
                        <div class="form-group col-md-2 col-sm-12 col-xs-12">
                            ...
                            <input class="form-control" type="text" id="anoSaldo" name="anoSaldo" value="{$anoSaldo}">
                        </div>
