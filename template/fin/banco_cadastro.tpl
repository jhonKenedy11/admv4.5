                ...
                <div class="x_panel">
                  ...
                  <form class="container" novalidate="" action="/echo" method="POST" id="myForm">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id">Banco</label>
                        <div class="col-md-2 col-sm-4 col-xs-6">
                          <input id="id" name="id" type="number" required="true"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  id="nome" name="nome" type="text" required="true"
                                  class="form-control col-md-7 col-xs-12" maxlength="60"
                                  tittle="Preencha este campo com letras ou numeros, até 60 caracteres." 
                                  placeholder="Digite o Nome do Banco."  value={$nome}>
                        </div>
                      </div>
                    </form>
