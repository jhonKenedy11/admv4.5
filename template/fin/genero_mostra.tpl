    ...
    <div class="">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>G&ecirc;nero Financeiro - Consulta</h2>
                ...
                <tbody>
                  ...
                  {section name=i loop=$lanc}
                    ...
                    <tr class="even pointer">
                      ...
                      <td> {$lanc[i].DESCLANCAMENTO} </td>
                      <td class=" last">
                        <button type="button" class="btn btn-primary btn-xs"
                          onclick="javascript:submitAlterar('{$lanc[i].GENERO}');"><span
                            class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
                        <button type="button" class="btn btn-danger btn-xs"
                          onclick="javascript:submitExcluir('{$lanc[i].GENERO}');"><span class="glyphicon glyphicon-trash"
