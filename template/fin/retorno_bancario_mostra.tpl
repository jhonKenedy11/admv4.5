            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                        ...
                        <input name=retorno       type=hidden value={$retorno}>
                            ...
                            <div class="form-group col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <span class="btn btn-default btn-file"><input type="file" style="width: 473px !important;" name="fileArq"/></span>
                                </div>
                            </div>
                        ...
                        {if $retorno eq 'P' or $retorno eq 'B'}
                            ...
                            {/section} 
                                <tr class="even pointer danger">
                                    <td colspan="10">Quantidade de registros no retorno: &nbsp;<b><i>{$numReg}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="10"> Data retorno: &nbsp;<b>{$lancHeader[0].dataArq|date_format:"%e %b, %Y"}</b></td>
                                </tr>
                                <tr>
                                    <td colspan="10"> Nome Arquivo: &nbsp;<b><i>{$filePesquisa}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2"> 02 - ENTRADA CONFIRMADA: &nbsp;<b><i>{$lancTrailler[0].quantReg02}</i></b></td>
                                    <td colspan="8"> Total: &nbsp;<b><i>{$lancTrailler[0].valorReg02|number_format:2:",":"."}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2"> 09/10 - BAIXADO (sem recebimento): &nbsp;<b><i>{$lancTrailler[0].quantReg0910Baixado}</i></b></td>
                                    <td colspan="8"> Total: &nbsp;<b><i>{$lancTrailler[0].valorReg0910Baixado|number_format:2:",":"."}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2"> 06 - LIQUIDAÇÂO NORMAL: &nbsp;<b><i>{$lancTrailler[0].quantReg06Liquidacao}</i></b></td>
                                    <td colspan="8"> Total: &nbsp;<b><i>{$lancTrailler[0].valorReg06Liquidacao|number_format:2:",":"."}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2"> 17 - LIQUIDAÇÂO APÓS BAIXA OU TÍTULO NÃO REGISTRADO: &nbsp;<b><i>{$lancTrailler[0].quantReg17}</i></b></td>
                                    <td colspan="8"> Total: &nbsp;<b><i>{$lancTrailler[0].valorReg17|number_format:2:",":"."}</i></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2"> 17 - TARIFA: &nbsp;<b><i>{$lancTrailler[0].quantReg28}</i></b></td>
                                    <td colspan="8"> Total: &nbsp;<b><i>{$lancTrailler[0].valorReg28|number_format:2:",":"."}</i></b></td>
                                </tr>
                            </tbody>
                        {else}
                  ...
                  {else}
                    <div>
                        <h5><center><i>Selecione o arquivo de retorno clique em <b>consolidar</b></i></center></h5>
                        <p>
                        <h5><center><i>Após consolidar o retorno clique em <b>confirmar</b></i></center></h5>
                    </div>
                  {/if}
