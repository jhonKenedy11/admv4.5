...
<div class="right_col" role="main">
  <div class="">
    ...
    <form id="lancamento" data-parsley-validate class="form-horizontal form-label-left" NAME="lancamento"
      ...
      <input name=form type=hidden value="situacao">
            ...
            <div class="x_title">
              <h2>
                {if $subMenu eq "cadastrar"}
                  Situa&ccedil;&otilde;es -  Cadastro
                {else}
                  Situa&ccedil;&otilde;es - Altera&ccedil;&atilde;o
                {/if}
                {if $mensagem neq ''}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="descricao" name="descricao" type="text" required="required"
                    ...
                    placeholder="Digite o descricao do equipamento." value={$descricao}>
                </div>
              </div>

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ativo">Ativo <span
                    class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="ativo" name="ativo" type="text" required="required" class="form-control col-md-7 col-xs-12"
                    tittle="Preencha este campo com numero, até 1 caracteres." placeholder="Digite o valor para ativo."
                    value={$ativo}>
                </div>
              </div>
