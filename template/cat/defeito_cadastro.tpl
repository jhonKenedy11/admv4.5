<script type="text/javascript" src="{$pathJs}/cat/s_defeito.js"> </script>
        <!-- page content -->
      ...
      <div class="">
        ...
        <form id="lancamento" data-parsley-validate class="form-horizontal form-label-left" NAME="lancamento"  ACTION="{$SCRIPT_NAME}" METHOD="post">
            ...
            <input name=form                type=hidden value="defeito">   
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  id="descricao" name="descricao" type="text" required="required" 
                                  ...
                                  placeholder="Digite o descricao do defeito."  value={$descricao}>
                        </div>
                      </div>
