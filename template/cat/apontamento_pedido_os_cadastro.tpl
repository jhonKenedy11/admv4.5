<script type="text/javascript" src="{$pathJs}/cat/s_apontamento_pedido_os.js"> </script>    
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>  
      ...
      <div class="">
        ...
        <div class="page-title">
          <div class="title_left">
              <h3>Apontamento de OS Pedido</h3>
          </div>
        </div>
    ...
    <form id="lancamento" name="lancamento" data-parsley-validate METHOD="POST"
        ...
        <input name=form                type=hidden value="apontamento_pedido_os">   
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="form-group line-formated">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <label for="contato">OS</label>
                            <input type="text" class="form-control input-sm" readonly id="atendimentoId" name="atendimentoId" placeholder="Num OS" required
                               value="{$atendimentoId}"> 
                    </div> 
                    ...
                    <div class="col-md-5 col-sm-6 col-xs-6">
                        <label for="contato">Cliente</label>
                            <input type="text" class="form-control input-sm" readonly id="nome" name="nome" placeholder="Cliente" required
                               value="{$nome}"> 
                    </div> 

                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <label for="contato">Contato</label>
                            <input type="text" class="form-control input-sm" readonly id="contato" name="contato" placeholder="Contato" required
                               value="{$contato}"> 
                    </div> 
                ...
                <div class="form-group line-formated">                 
                    <div class="col-md-5 col-sm-6 col-xs-6">
                        <label for="contato">Descricao Equipamento</label>
                            <input type="text" class="form-control input-sm" readonly id="descEquipamento" name="descEquipamento" placeholder="Equipamento" required
                ...
                <!--div class="form-group line-formated">                 
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <label for="obs" >Observações Pedido</label>
                        <textarea class="resizable_textarea form-control input-sm" readonly id="obs" name="obs" rows="2" >{$obs}</textarea>
                    </div>  
                </div-->
                <div class="form-group line-formated">                 
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <label for="obs" >Observações OS</label>
                        <textarea class="resizable_textarea form-control input-sm" readonly id="obsOs" name="obsOs" rows="2" >{$obsOs}</textarea>
                    </div>  
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <label for="obsServico" >Observações Serviço</label>
                        <textarea class="resizable_textarea form-control input-sm" readonly id="obsServicos" name="obsServicos" rows="2" >{$obsServicos}</textarea>
                    </div> 
                </div>
                <div id="divTotal" class="form-group line-formated">
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <label for="valorPecas">Valor Itens</label>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control input-sm" placeholder="Total Pedido." id="valorTotal" 
                                    name="valorTotal" value="{$valorTotal}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <label for="valorPecas">Valor Itens Utilizado</label>
                        <div class="input-group">
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-sm" type="button">R$</button>
                            </span>
                            <input class="form-control input-sm" placeholder="Valor Peças Utilizado." id="valorPecasUtilizado" 
                                    name="valorPecasUtilizado" value="{$valorPecasUtilizado}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <label for="valorPecas">TOTAL com Itens Utilizado</label>
                        <div class="input-group">
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-sm" type="button">R$</button>
                            </span>
                            <input class="form-control input-sm" placeholder="Valor Peças Utilizado." id="totalPecasUtilizado" 
                                    name="totalPecasUtilizado" value="{$totalPecasUtilizado}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group line-formated">
                                    <div class="col-md-2 col-sm-12 col-xs-12 has-feedback">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm"  onClick="javascript:submitConfirmarTodasQtdeUtilizada();">
                                        <span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span><span> Todos Utilizados</span></button>                            
                                    </div>
                                    <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                                        <label for="codProduto">Cód. Interno</label>
                                    ...
                                    <div class="col-md-5 small col-sm-12 col-xs-12 has-feedback">
                                        ...
                                        <input class="form-control input-sm" type="text" id="descricaoProduto" 
                                            name="descricaoProduto" placeholder="Descrição Produto" alt="Unidade" value={$descricaoProduto}>
                                    </div>
                                    
                                    <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                                        <label for="uniProduto">Qtde Utilizada</label>
                                        <input class="form-control input-sm money" type="text" id="qtdeUtilizada" 
                                            name="qtdeUtilizada" placeholder="Qtde Utilizada" alt="Quantidade Utilizada" value={$qtdeUtilizada}>
                                    </div>
                            ...
                            <table id="datatable-buttons-pecas" class="table table-bordered jambo_table">
                                ...
                                <tbody>
                                    {section name=i loop=$lancPecas}
                                        <tr>
                                            <td> {$lancPecas[i].ITEMESTOQUE} </td>
                                            <td> {$lancPecas[i].NRITEM} </td>
                                            <td> {$lancPecas[i].DESCRICAO} </td>
                                            <td> {$lancPecas[i].QTSOLICITADA|number_format:2:",":"."} </td>
                                            <td> {$lancPecas[i].QUANTIDADEUTILIZADA|number_format:2:",":"."} </td>
                                            <td> {$lancPecas[i].UNITARIO|number_format:2:",":"."} </td>
                                            <td> {$lancPecas[i].DESCONTO|number_format:2:",":"."} </td>
                                            <td> {$lancPecas[i].PERCDESCONTO|number_format:2:",":"."} </td>
                                            <td> {$lancPecas[i].TOTAL|number_format:2:",":"."} </td>
                                            <td> 
                                                <button type="button" class="btn btn-primary btn-xs" onclick="javascript:editarPeca(this, '{$lancPecas[i].ID}')" ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button> 
                                            </td>
                                            </tr>
                                        <p>
                                    {/section} 
                        ...
                        <div role="tabpanel" class="tab-pane fade {if $tab eq 'serviço'} active in {/if} small" id="tab_content3" aria-labelledby="profile-tab">
                                ...
                                <table id="datatable-buttons-servicos" class="table table-bordered jambo_table">
                                    ...
                                    <tbody>
                                        {section name=i loop=$lancServicos}
                                            <tr>
                                                <td>  <input type="checkBox"  name="checkedServ" id="check{$lancServicos[i].ID}" onchange="javascript:buscaApontamentosServico('{$lancServicos[i].ID}')"/> </td>
                                                ...
                                                <td> 
                                                    <button type="button" class="btn btn-primary btn-xs" onclick="javascript:cadastrarApontamento(this)" data-toggle="modal"  data-target="#modalCadastraApontamento"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button> 
                                                </td>
                                            </tr>
                                            <p>
                                        {/section} 
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <table id="datatable-buttons-apontamento" class="table table-bordered jambo_table">
                                    <h2>Apontamentos</h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        {section name=i loop=$lancItens}
                                            <tr>
                                                ...
                                                <td> {$lancItens[i].DATA_INICIO|date_format:"%d/%m/%Y %H:%M:%S"} </td>
                                                <td> {$lancItens[i].DATA_FIM|date_format:"%d/%m/%Y %H:%M:%S"} </td>
                                                <td> {$lancItens[i].TOTALHORAS} </td>
                                                <td style="display:none"> {$lancItens[i].USER_ID} </td>
                                                <td> 
                                                     <button type="button" class="btn btn-primary btn-xs" onclick="javascript:editarApontamento(this)" data-toggle="modal"  data-target="#modalCadastraApontamento"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button> 
                                                     <button type="button" class="btn btn-danger btn-xs" onclick="javascript:submitExcluiApontamento('{$lancItens[i].ID}');"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button> 
                                                </td>
                                            </tr>
                                            <p>
                                        {/section} 
