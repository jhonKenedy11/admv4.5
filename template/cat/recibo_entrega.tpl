...
<div class="right_col" role="main">
      ...
      <div class=" col-md-12 col-sm-12 col-xs-12 row invoice-info" style="margin: 0 auto; text-align: center; margin-top: 20px">
            <p>
            <h4><strong>RECIBO DE ENTREGA O.S N&deg; {$os[0].ID}</strong></h4>
            </p>
      </div>
      <!-- page content -->
      <div class="right_col container-tabela" role="main">
            <div class="row small ">
                  <div class="col-xs-12 table">
                        <table class="table table-bordered container-tabela" id="tab1" style="border:0;">
                                    <tbody>                                                            
                                          <tr>
                                                <td style="width: 200px;"><strong>Fornecedor</strong></td>
                                                <td>&nbsp;</td>
                                          </tr>
                                          <tr>
