        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Ordem de Serviço Financeiro
                                <strong>
                                    {if $mensagem neq ''}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-xs"
                                                onclick="javascript:submitCadastrarAtendimentoNf('{$lanc[i].ID}');"><span
                                                    class="glyphicon glyphicon-font" aria-hidden="true"
                                                    data-toggle="tooltip" title="Gerar NFE"></span></button>
                                        </td>
                                    </tr>
                                    <p>
                                    {/section}
