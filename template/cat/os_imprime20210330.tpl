                                                ...
                                                <strong><th><h4>PEÇAS UTILIZADAS</h4></th></strong>
                                                 <table class="table table-striped container-tabela" id="tab1">
                                                      ...
                                                      <tbody>
                                                            ...
                                                            {assign var="totalpec" value= $totalpec + (($osItem[i].VALORTOTAL - $osItem[i].DESCONTO))}
                                                            <tr>
                                                                  <td> {$osItem[i].CODPRODUTONOTA} </td>
                                                                  <td> {$osItem[i].DESCRICAO} </td>
                                                                  <td> {$osItem[i].QUANTIDADE|number_format:2:",":"."} </td>
                                                                  <td> {$osItem[i].UNIDADE} </td>
                                                                  <td> {$osItem[i].VALORUNITARIO|number_format:2:",":"."} </td>
                                                                  <td> {($osItem[i].VALORUNITARIO*$osItem[i].QUANTIDADE)|number_format:2:",":"."} </td>
                                                                  <td> {$osItem[i].PERCDESCONTO|number_format:2:",":"."} </td>
                                                                  <td> {$osItem[i].DESCONTO|number_format:2:",":"."} </td>
                                                                  <td> {($osItem[i].VALORTOTAL - $osItem[i].DESCONTO)|number_format:2:",":"."} </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <td></td>
                                                                  <td></td>
                                                                  <td><h4> {$totalpec|number_format:2:",":"."} </h4></td>
                                                            </tr> 
                                                ...
                                                <table class="table table-striped container-tabela" id="tab1">
                                                      ...
                                                      <tbody>
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <td></td>
                                                                  <td></td>
                                                                  <td><h4> {$totalserv|number_format:2:",":"."} </h4></td>
                                                            </tr>  
