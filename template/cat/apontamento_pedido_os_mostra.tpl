                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form id="lancamento" name="lancamento" data-parsley-validate METHOD="POST"
                                ...
                                <input name=situacoesPedido type=hidden value={$situacoesPedido}>
                                <input name=dataIni type=hidden value={$dataIni}>
                                <input name=dataFim type=hidden value={$dataFim}>

                                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                                    <label>Num Pedido</label>
                                    <input class="form-control" id="numPedido" name="numPedido"
                                        placeholder="Num Pedido." value={$numPedido}>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-6">
                                    <label>Situação</label>
                                    <select class="select2_multiple form-control" multiple="multiple"
                                        id="situacaoPedido" name="situacaoPedido">
                                        {html_options values=$situacaoPedido_ids output=$situacaoPedido_names selected=$situacaoPedido_id}
                                    </select>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $("#situacaoPedido.select2_multiple").select2({
