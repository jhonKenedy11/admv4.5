                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-primary"  onClick="javascript:submitCadastro('classe');">
                                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><span> Cadastro</span></button></li>                    </ul>
                            ...
                            <tbody>
                                ...
                                {section name=i loop=$lanc}
                                    ...
                                    <tr>
                                        <td> {$lanc[i].NOME} </td>
                                        <td> {$lanc[i].CCUSTO} </td>
                                        <td> {$lanc[i].VALIDADE|date_format:"%d/%m/%Y"} </td>
                                        <td >
