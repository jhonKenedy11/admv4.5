<style type="text/css">
  ...
  .right_col { padding-left: 0px !important; padding-right: 0px !important; }
  .x_panel { padding-top: 5px !important; }
</style>

<script src="{$pathSweet}/dist/sweetalert2.all.min.js"></script>
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              <div class="row" style="margin-bottom: 15px;">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="filtro_empresa" id="filtro_empresa"
                    placeholder="Filtrar por nome da empresa..." value="{$filtro_empresa|escape:'html'}">
                </div>
                <div class="col-md-6">
                ...
                <tbody>
                  ...
                  {section name=i loop=$lanc}
                    ...
                    <tr class="even pointer">
                      ...
                      <td>{$lanc[i].CNPJ_FORMATADO|default:$lanc[i].CNPJ}</td>
                      <td>{$lanc[i].MODELO_DESC|default:$lanc[i].MODELO}</td>
                      <td>{$lanc[i].SERIE}</td>
                      <td>{$lanc[i].CFOP}</td>
                      <td>
                        <button type="button" class="btn btn-primary btn-xs"
                          onclick="javascript:submitAlterar('{$lanc[i].FILIAL}', '{$lanc[i].MODELO}');"><span class="glyphicon glyphicon-pencil"
                            aria-hidden="true"></span></button>
                        <button type="button" class="btn btn-danger btn-xs"
                          onclick="javascript:submitExcluir('{$lanc[i].FILIAL}', '{$lanc[i].MODELO}');"><span class="glyphicon glyphicon-trash"
                            aria-hidden="true"></span></button>
                      </td>
                    </tr>
                  {/section}
