      ...
      <div class="">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                  <div>
                      ...
                      -->
                              <center>
                                    <strong>TABELA DE PREÇOS POR GRUPO</strong><br>
                                    <!-- Periodo
                                          ...
                                          <div class="col-xs-12 table">
                                                <table class="table table-striped">
                                                      ...
                                                      <tbody>
                                                            ...
                                                            {assign var="grupo" value=""}
                                                            {section name=i loop=$pedido}
                                                                  {if $pedido[i].GRUPO neq $grupo }
                                                                        <th id="date" colspan="5">{$pedido[i].NOMEGRUPO}</th>
                                                                        {assign var="grupo" value=$pedido[i].GRUPO}
                                                                  {/if}
