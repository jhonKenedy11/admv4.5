...
<div class="right_col" role="main">                
    <form class="full" NAME="lancamento" METHOD="POST" class="form-horizontal form-label-left" novalidate ACTION={$SCRIPT_NAME} >
        ...
        <input name=cclasstrib    type=hidden value=""> 
                                ...
                                <tbody>
                                    {section name=i loop=$lanc}
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td> {$lanc[i].NOME} </td>
                                            <td> {$lanc[i].CST} {if $lanc[i].CST_DESCRICAO} - {$lanc[i].CST_DESCRICAO}{/if}</td>
                                            <td> {$lanc[i].TIPO_ALIQUOTA} </td>
                                            <td class="last">
