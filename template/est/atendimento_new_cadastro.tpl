                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <li><button type="button" class="btn btn-danger"  onClick="javascript:submitVoltar('');">
                                <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span><span> Lista OS</span></button>
                        </li>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group line-formated">
                                    <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                                        <label for="codProduto">ID</label>
                                        <input class="form-control input-sm" type="text" id="codProduto" 
                                            name="codProduto" placeholder="Id Produto" value={$codProduto}>
                                    </div>
                                    <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 line-formated">
                                        ...
                                        <div class="input-group line-formated">
                                            <input type="text" class="form-control input-sm" id="descProduto" name="descProduto" placeholder="Produto" required
                                                value="{$descProduto}" readonly>
                                            <span class="input-group-btn">
                                                <button type="button" class="btn btn-primary btn-sm" 
                                                       onClick="javascript:abrir('{$pathCliente}/index.php?mod=est&form=produto&opcao=pesquisar&from=atendimento_new', 'produto');">
                                                    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                </button>
                                            </span>                                
                                        </div>
                                ...
                                <div class="form-group line-formated">
                                    <div class="col-md-2 small col-sm-12 col-xs-12 has-feedback">
                                        ...
                                        <input class="form-control input-sm money" type="text" id="quantidadePecas" 
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 line-formated">
                                        ...
                                        <div class="input-group line-formated">
                                            <input type="text" class="form-control input-sm" id="descricaoServico" name="descricaoServico" placeholder="Serviço" required
                                                value="{$descricaoServico}" readonly>
                                            <span class="input-group-btn">
                                                <button type="button" class="btn btn-primary btn-sm" 
