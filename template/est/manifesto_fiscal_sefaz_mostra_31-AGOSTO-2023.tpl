                        ...
                        <tbody>
                            ...
                            {section name=i loop=$lanc}
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <button type="button" title="Autoriza NFe"
                                                class="btn btn-info btn-xs downloadXml" {if $lanc[i].XML eq ''}
                                                    onclick="javascript:submitDownloadXml('{$lanc[i].ID}');">
                                                {else}
                                    ...
                                    <td id="xml{$lanc[i].ID}" hidden> {$lanc[i].XML} </td>
