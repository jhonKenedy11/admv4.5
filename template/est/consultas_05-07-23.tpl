                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
                         <ul class="dropdown-menu" role="menu">
                              <li>
                                  ...
                                  <button id="limpaDados" type="button" class="btn btn-warning btn-xs" 
                ...
                <div class="x_panel" style="height: 100%;">
                    <div class="menu_section">
                        ...
                        <div class="dropdown-container">
                            <a href="javascript:abrir('{$pathCliente}/index.php?mod=ped&form=rel_pedidos&opcao=imprimir&submenu=relatorioVendas');">Pedido</a><br>
                        </div-->
                        ...
                        <div class="dropdown-container">
                            ...
                            <button type="button" title="Relatório de Compras" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioCompras();">
                                <span>Compras</span>
                            </button><br>
                            <button type="button" title="Relatório de Compras por estoque minimo" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioComprasEstoqueMin();">
                                <span>Compras E. Minimo</span>
                            </button><br>
                            <button type="button" title="Relatório Sugestões de Compras" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioSugestoesCompras();">
                                <span>Sugestões Compras</span>
                            </button><br>
                            <button type="button" title="Tabela de Precos por ordem Alphabetica" class="btn btn-dark btn-xs" 
                                    onClick="javascript:tabelaPrecos();">
                                <span>Tabela Preços</span>
                            </button><br>
                            <button type="button" title="Tabela de precos por Grupos" class="btn btn-dark btn-xs" 
                                    onClick="javascript:tabelaPrecosGrupo();">
                                <span>Tabela Preços por Grupo</span>
                            </button><br>
                            <button type="button" title="Relatório de Estoque Geral" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioEstoqueGeral();">
                                <span>Estoque Geral</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioMovimentoEstoque();">
                                <span>Mov. de Estoque</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque por Cliente" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioMovimentoEstoqueCliente();">
                                <span>Mov. Estoque 
                                     Conta</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque Localizacao" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioMovimentoEstoqueLocalizacao();">
                                <span>Mov. de Estoque Localizacao</span>
                            </button><br>

                            <button type="button" title="Relatório de Material Consumo Conta" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioMaterialConsumoConta();">
                                <span>Material Consumo Conta</span>
                            </button><br>

                            <button type="button" title="Relatório Kardex Analitico" class="btn btn-dark btn-xs" 
                                    onClick="javascript:relatorioKardex();">
                                <span>Kardex Analítico</span>
                            </button><br>
                            <button type="button" title="Relatório Kardex Sintetico" class="btn btn-dark btn-xs" 
                            ...
                            <button type="button" title="Relatório Curva ABC" class="btn btn-dark btn-xs" 
