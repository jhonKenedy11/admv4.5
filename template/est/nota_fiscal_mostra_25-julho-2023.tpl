                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="lancamento" name="lancamento" data-parsley-validate METHOD="POST"
                        ...
                        <div class="form-group col-md-2 col-sm-1 col-xs-1">
                            <label>Modelo</label>
                            <input class="form-control" id="modeloNf" name="modeloNf" placeholder="Modelo da nota fiscal a pesquisar."  value={$modeloNf} >
                        </div>
                            ...
                            <tr>
                                ...
                                {else}
                                    <td>
                                        ...
                                        <button type="button" title="Download XML" {if $lanc[i].PATHDANFE eq ''} disabled {/if} class="btn btn-success btn-xs">{if $lanc[i].PATHDANFE neq ''}<a href="{$xml_path}" download>{/if}<span class="glyphicon glyphicon-list" aria-hidden="true"></span></button>
                                    </td>
                                {/if}
                            </tr>
                        {/section} 
