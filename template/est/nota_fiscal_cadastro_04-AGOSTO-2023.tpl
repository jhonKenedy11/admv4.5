                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        {if $subMenu neq "incluir"}
                            ...
                            <li>
                              <button type="button" class="btn btn-dark btn-xs"  onClick="javascript:addParcelasFinanceiro({$id});"><span> Parcelas Financeiro </span></button>
                            </li>
                            <li>
                              <button type="button" class="btn btn-dark btn-xs"  onClick="javascript:consultaMovimentoEstoque('movimento_estoque');"><span> Recebimento Produto</span></button>
                            </li>
                            <li>
                                <button type="button" class="btn btn-dark btn-xs"  onClick="javascript:calculoTributos({$id});"><span> C&aacute;lculo Tributos</span></button>
                            </li>
                            <li>
                               ____________________
                            </li>
                            <li>
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modalCarta"><span> Carta Correção NFe</span></button>
                            </li>
                            <li>
                              <button type="button" class="btn btn-warning btn-xs"  onClick="javascript:consultaMovimentoEstoque('movimento_estoque');"><span> Gerar XML</span></button>
                            </li>
                            <li>
                              <button type="button" class="btn btn-warning btn-xs"  onClick="javascript:geraDanfe({$id});"><span> Gera DANFE</span></button>
                            </li>
                            <!--li>
                              <button type="button" class="btn btn-warning btn-xs"  onClick="javascript:enviaEmailDanfe({$id});"><span> email XML/DANFE</span></button>
                            </li-->
                            <li>
                              <button type="button" class="btn btn-warning btn-xs"  data-toggle="modal" data-target="#modalEmail"><span> Email XML/DANFE</span></button>
                            </li>
                            
                            <li>
                              <button type="button" class="btn btn-warning btn-xs"  onClick="javascript:imprimirCCe({$id});"><span> imprimir CCe</span></button>
                            </li>
                            ...
                            <li>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalCancela"><span> Cancela NFe</span></button>
                            </li>
                            <li>
                              <button type="button" class="btn btn-danger btn-xs"  onClick="javascript:submitExcluir('$id');"><span> Exclui NF</span></button>
                            </li>
                        {/if}  
                    </ul>
            ...
            <div class="x_content">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6 text-left">
                        ...
                        <div class="input-group">
                            <input class="form-control input-sm" type="number"  onKeyPress="if(this.value.length==11) return false;" 
                                    placeholder="Numero NFe." id="numero" name="numero"{if $subMenu eq "cadastrar"} readonly {else} &nbsp;{/if} value={$numero}>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="input-group">
                            <input type="text" required="true" class="form-control input-sm" id="pessoaNome" name="nome" 
                                   readonly placeholder="Cliente ou Fornecedor" value="{$nome}">
                            <span class="input-group-btn">
                ...
                <div class="x_panel">
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="produtos-tab" data-toggle="tab" aria-expanded="false">Produtos</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content4" role="tab" id="nfe-tab" data-toggle="tab" aria-expanded="false">Nfe</a>
                        </li>
                      </ul>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="dataSaidaEntrada" value={$dataSaidaEntrada}>
                                    </div>
                                </div>
                            ...
                            <div class="row">                           
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btnDes" tabindex="-1" type="button">R$
                                            </button>
                                        </span>
                                        <input class="form-control input money" type="money" maxlength="10" name="frete" value={$frete} onchange="javascript:calculaTotalNfAjax(frete.value, despacessorias.value, seguro.value);">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control input money" type="money" maxlength="10" name="despacessorias" value={$despacessorias} onchange="javascript:calculaTotalNfAjax(frete.value, despacessorias.value, seguro.value);">
                                    </div>  
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btnDes" hidden tabindex="-1" type="button">R$
                                            </button>
                                        </span>
                                        <input class="form-control input money" type="money" maxlength="10  " name="seguro" value={$seguro} onchange="javascript:calculaTotalNfAjax(frete.value, despacessorias.value, seguro.value);">
                                    </div>  
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="panel panel-default">
                                        <textarea class="form-control" placeholder="Digite a observação." rows="3"  id="obs" name="obs">{$obs}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea class="form-control" placeholder="Digite a justificativa para cancelamento." rows="4"  id="justificativa" name="justificativa">{$justificativa}</textarea>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:cancelaNFE({$id});">Confirma</button>
          ...
          <div class="modal fade" id="modalCarta" role="dialog">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea class="form-control" placeholder="Digite o texto para a carta de carreção." rows="4"  id="carta" name="carta">{$carta}</textarea>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="javascript:cartaCNFE({$id});">Confirma</button>
                  <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                </div>
              </div>
            </div>
