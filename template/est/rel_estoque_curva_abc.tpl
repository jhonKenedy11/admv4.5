...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            if (typeof converteColunaNumeroBR === 'function') {
                  converteColunaNumeroBR(ws, 6); // Venda
                  converteColunaNumeroBR(ws, 7); // Qtde
                  converteColunaNumeroBR(ws, 8); // Valor
            }
            ...
            var dataIni = '{$dataIni}';
            var dataFim = '{$dataFim}';
            var nomeArquivo = 'Curva_ABC_' + dataIni.replace(/\//g, '_') + '_a_' + dataFim.replace(/\//g, '_') + '.xlsx';
