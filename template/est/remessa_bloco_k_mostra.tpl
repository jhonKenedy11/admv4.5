          ...
          <div class="x_title">
            <h2>Remessa BLOCO K
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><button type="button" class="btn btn-warning" onClick="javascript:submitLetraBlocoK();">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li>
                      <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                        data-target="#modalTeste"><span>Enviar Email</span></button>
                    </li>
                  </ul>
                </li>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <textarea class="form-control" placeholder="Digite o email." rows="1" id="emailContador"
                          name="emailContador">{$emailContador}</textarea>
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                          onClick="javascript:enviarFile();">Enviar</button>
