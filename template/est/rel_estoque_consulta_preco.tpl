                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2 class="text-center">
                                    <strong>CONSULTA DE PREÇOS</strong><br>
                              ...
                              <table class="table table-striped" style="margin-bottom: 0;">
                                    <thead>
                                          <tr>
                                                ...
                                                <th style="width: 8%; text-align: center;">Valor Unitário</th>
                                                <th style="width: 8%; text-align: center;">Valor Total</th>
                                                <th style="width: 8%; text-align: center;">Desconto</th>
                                                <th style="width: 8%; text-align: center;">Valor Líquido</th>
                                                <th style="width: 8%;">Observações</th>
                                          </tr>
                                    </thead>
                                    <tbody>
                                          {foreach $resultado as $item}
                                                <tr>
                                                      ...
                                                      <td style="text-align: center;">R$ {$item.VALOR_UNITARIO|number_format:2:',':'.'}</td>
                                                      <td style="text-align: center;">R$ {$item.VALOR_TOTAL|number_format:2:',':'.'}</td>
                                                      <td style="text-align: center;">{$item.DESCONTO_PERCENTUAL|number_format:2:',':'.'}%</td>
                                                      <td style="text-align: center;">R$ {$item.VALOR_LIQUIDO|number_format:2:',':'.'}</td>
                                                      <td>{$item.OS}</td>
                                                </tr>
                                          {/foreach}
                                    </tbody>
...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Consulta Preços");

            var dataIni = '{$dataIni}';
            var dataFim = '{$dataFim}';
            var nomeArquivo = 'Consulta_Precos_' + dataIni.replace(/\//g, '_') + '_a_' + dataFim.replace(/\//g, '_') + '.xlsx';
