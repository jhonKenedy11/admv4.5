                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2 class="text-center">
                                    <strong>RELATÓRIO DE COMPRAS</strong><br>
                                    <strong>Período: {$dataIni} a {$dataFim}</strong><br>
                              </h2>
                        </div>
                  </div>
                              ...
                              <table class="table table-striped" style="margin-bottom: 0;">
                                    <thead>
                                          <tr>
                                                ...
                                                <th style="width: 12%; text-align: left;">Fornecedor</th>
                                                ...
                                                <th style="width: 6%; text-align: center;">Usuário</th>
                                          </tr>
                                    </thead>
                                    <tbody>
                                          {foreach $resultado as $item}
                                                <tr>
                                                      ...
                                                      <td style="text-align: center;">{$item.QUANTIDADE|number_format:0:',':'.'}</td>
                                                      <td style="text-align: center;">{$item.VALOR_UNITARIO|number_format:2:',':'.'}</td>
...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            var dataIni = '{$dataIni}';
            var dataFim = '{$dataFim}';
            var nomeArquivo = 'Relatorio_Compras_' + dataIni.replace(/\//g, '_') + '_a_' + dataFim.replace(/\//g, '_') + '.xlsx';
