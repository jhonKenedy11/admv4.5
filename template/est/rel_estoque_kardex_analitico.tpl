                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2 class="text-center">
                                    <strong>KARDEX ANALÍTICO</strong><br>
                              ...
                              <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tbody>
                                          {foreach $resultado as $item}
                                                <tr>
                                                      <td>{$item.DATAEMISSAO|date_format:"%d/%m/%Y"}</td>
                                                      <td>
...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            if (typeof converteColunaNumeroBR === 'function') {
                  converteColunaNumeroBR(ws, 7); // Quantidade
            }

            XLSX.utils.book_append_sheet(wb, ws, "Kardex Analítico");

            var dataIni = '{$dataIni}';
            var dataFim = '{$dataFim}';
            var nomeArquivo = 'Kardex_Analitico_' + dataIni.replace(/\//g, '_') + '_a_' + dataFim.replace(/\//g, '_') + '.xlsx';
