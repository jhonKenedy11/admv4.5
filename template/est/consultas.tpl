                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        ...
                                        <button id="limpaDados" type="button"
                        ...
                        -->
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <SELECT class="js-example-basic-single form-control" id="tipoGrupo"
                                        name="tipoGrupo">
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                    <label>Grupo</label>
                                    <SELECT class="select2_multiple form-control" multiple="multiple" id="grupo"
                                        name="grupo">
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" readonly type="text" id="descProduto"
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    <label>Localização</label>
                                    <SELECT class="select2_multiple form-control" multiple="multiple" id="localizacao"
                                        name="localizacao">
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                    <label>Tipo NF</label>
                                    <select class="select2_multiple form-control" multiple="multiple" id="tipolanc"
                                        name="tipolanc">
                                ...
                                <div class="form-group col-md-5 col-sm-12 col-xs-12">
                                    ...
                                    <select class="select2_multiple form-control" multiple="multiple" id="sitlanc"
                                        name="sitlanc">
                                ...
                                <div class="form-group col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control" id="numNf" name="numNf" placeholder="Numero NF"
                                        value={$numNf}>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="x_panel" style="padding: 1px;">
                    <div class="menu_section">
                        <button class="dropdown-btn">
                            <center><i class="fa fa-file"></i> Relatórios</center>
                        </button>
                        <div class="dropdown-container">
                            ...
                            <button type="button" title="Relatório de Compras por estoque minimo"
                                class="btn btn-dark btn-xs btnRelatorios"
                                onClick="javascript:relatorioComprasEstoqueMin();">
                                <span>Compras E. Minimo</span>
                            </button><br>
                            <button type="button" title="Relatório Sugestões de Compras"
                                class="btn btn-dark btn-xs btnRelatorios"
                                onClick="javascript:relatorioSugestoesCompras();">
                                <span>Sugestões Compras</span>
                            </button><br>
                            <button type="button" title="Tabela de Precos por ordem Alphabetica"
                                class="btn btn-dark btn-xs btnRelatorios" onClick="javascript:tabelaPrecos();">
                                <span>Tabela Preços</span>
                            </button><br>
                            <button type="button" title="Tabela de precos por Grupos"
                                class="btn btn-dark btn-xs btnRelatorios" onClick="javascript:tabelaPrecosGrupo();">
                                <span>Tabela Preços por Grupo</span>
                            </button><br>
                            <button type="button" title="Relatório de Estoque Geral"
                                class="btn btn-dark btn-xs btnRelatorios" onClick="javascript:relatorioEstoqueGeral();">
                                <span>Estoque Geral</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque"
                                class="btn btn-dark btn-xs btnRelatorios"
                                onClick="javascript:relatorioMovimentoEstoque();">
                                <span>Mov. de Estoque</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque por Cliente"
                                class="btn btn-dark btn-xs btnRelatorios"
                                onClick="javascript:relatorioMovimentoEstoqueCliente();">
                                <span>Mov. Estoque
                                    Conta</span>
                            </button><br>
                            <button type="button" title="Relatório de Movimento de Estoque Localizacao"
                                class="btn btn-dark btn-xs btnRelatorios"
                            ...
                            <button type="button" title="Relatório de Material Consumo Conta"
                                class="btn btn-dark btn-xs btnRelatorios"
                                onClick="javascript:relatorioMaterialConsumoConta();">
                                <span>Material Consumo Conta</span>
                            </button><br>

                            <button type="button" title="Relatório Kardex Analitico"
                                class="btn btn-dark btn-xs btnRelatorios" onClick="javascript:relatorioKardex();">
                                <span>Kardex Analítico</span>
                            </button><br>
                            <button type="button" title="Relatório Kardex Sintetico"
                                class="btn btn-dark btn-xs btnRelatorios"
...
<script>
    ...
    $("#localizacao.select2_multiple").select2({
        placeholder: "Selecione 2 localizações a inicial e a final",
