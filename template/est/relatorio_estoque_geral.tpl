                                                ...
                                                <table class="table table-striped">
                                                      <thead>
                                                            <tr>
                                                                  ...
                                                                  <th>ULTIMA COMPRA</th>
                                                                  <th>CUSTO MÉDIO</th>
                                                                  <th>CUSTO REPOSICAO</th>
                                                                  <th>VLR INFORMADO CUSTO</th>
                                                                  <th>PRECO MIN</th>
                                                                  <th>PREÇO VENDA</th>
                                                                  <th>MARGEM</th>
                                                            </tr>
                                                      ...
                                                      <tbody>
                                                            ...
                                                            {section name=i loop=$pedido}
                                                                  ...
                                                                  {else}
                                                                        {assign var="margem" value="0.00"}
                                                                  {/if}
                                                                  <tr>
                                                                        <td> {$pedido[i].GRUPO} - {$pedido[i].NOMEGRUPO} </td>
                                                                        <td> {$pedido[i].CODIGO} </td>
                                                                        <td> {$pedido[i].DESCRICAO} </td>
                                                                        <td> {$pedido[i].ESTOQUE|number_format:2:",":"."}</td>
                                                                        <td> {$pedido[i].CUSTOCOMPRA|number_format:2:",":"."}
                                                                        </td>
                                                                        <td> {$pedido[i].CUSTOMEDIO|number_format:2:",":"."}
                                                                        </td>
                                                                        <td> {$pedido[i].CUSTOREPOSICAO|number_format:2:",":"."}
                                                                        </td>
                                                                        <td> {$pedido[i].PRECOINFORMADO|number_format:2:",":"."}
                                                                        </td>
                                                                        <td> {$pedido[i].PRECOMINIMO|number_format:2:",":"."}
                                                                        </td>
