                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2 class="text-center">
                                    <strong>ESTOQUE POR LOCALIZAÇÃO</strong><br>
                  ...
                  {if !empty($resultado)}
                        <div class="table-responsive">
                              <table class="table table-striped" style="margin-bottom: 0;">
                                    <thead>
                                          <tr>
                                                <th style="width: 7%; text-align: center;">Localização</th>
                                                ...
                                                <th style="width: 8%; text-align: center;">Custo Médio</th>
                                    ...
                                    <tbody>
                                          {foreach $resultado as $item}
                                                <tr>
                                                      <td style="text-align: center;">{$item.LOCALIZACAO}</td>
                                                      ...
                                                      <td style="text-align: center;">{($item.ESTOQUE - $item.RESERVA)|number_format:0:',':'.'}</td>
                                                      <td style="text-align: center;">{$item.CUSTOCOMPRA|number_format:2:',':'.'}</td>
                                                      <td style="text-align: center;">{$item.CUSTOMEDIO|number_format:2:',':'.'}</td>
...
<script type="text/javascript">
      function exportarTabelaParaExcel() {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Estoque Localização");

            var dataImp = '{$dataImp}';
            var nomeArquivo = 'Estoque_Localizacao_' + dataImp.replace(/\//g, '_') + '.xlsx';
