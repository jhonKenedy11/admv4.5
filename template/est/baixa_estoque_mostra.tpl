                ...
                <div class="x_content">
                    ...
                    <form id="lancamento" name="lancamento" data-parsley-validate METHOD="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-2 col-sm-12 col-xs-12">
                                <label>Qtde Entrada</label>
                                <input class="form-control money" id="qtdeEntrada" name="qtdeEntrada" placeholder="Qtde de Entrada." onchange="javascript:calculaQuantidadeProduto();"  value={$qtdeEntrada} >
                            </div>

                            <div class="form-group col-md-2 col-sm-12 col-xs-12">
                                <label>Nova Qtde Estoque</label>
                                <input readonly class="form-control" id="novaQtdeEstoque" name="novaQtdeEstoque" placeholder="Nova Qtde Estoque."  value={$novaQtdeEstoque} >
                            </div>
                        </div>
