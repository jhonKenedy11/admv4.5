                                          ...
                                          <table class="table table-striped">
                                                <thead>
                                                      <tr>
                                                            ...
                                                            <th style="width: 36%; text-align: left;">Descrição</th>
                                                            <th style="width: 16%; text-align: left;">Grupo</th>
                                                ...
                                                <tbody>
                                                      ...
                                                      <tr class="pedido-total">
                                                            <td colspan="6" style="text-align: right;">Total em falta no pedido</td>
