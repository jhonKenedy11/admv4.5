<style>
      ...
      .table, .table th, .table td, .table td * {
            color: #000 !important;
      }
                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5">
                        <div>
                              <h2 class="text-center">
                                    <strong>RELATÓRIO DE NOTAS FISCAIS</strong><br>
                                    <strong>Período: {$dataIni} a {$dataFim}</strong>
                              </h2>
                        </div>
                  </div>
                              ...
                              <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tbody>
                                          ...
                                          {foreach $resultado as $item}
                                                <tr>
                                                      <td>{$item.CLIENTE|default:'Cliente não identificado'}</td>
                                                ...
                                                {assign var="totalGeral" value=$totalGeral+$item.VALOR_TOTAL}
