...
<!--<script type="text/javascript" src="{$pathJs}/est/s_anp.js"> </script>-->
...
<script type="text/javascript" src="{$pathSweet}/dist/sweetalert2.all.min.js"></script>
      ...
      <div class="">
        ...
        <form id="lancamento" data-parsley-validate class="form-horizontal form-label-left" NAME="lancamento"  ACTION="{$SCRIPT_NAME}" METHOD="post">
            ...
            <input name=form                type=hidden value="anp">   
                ...
                <div class="x_panel">
                  ...
                  <form class="container" novalidate="" action="/echo" method="POST" id="myForm">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="id">ANP</label>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" maxlength="9" required="true" id="id" 
                               tittle="Preencha este campo com numeros, até 9 caracteres." 
                               name="id" placeholder="Digite o ANP." value={$id}>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="descricao">Descri&ccedil;&atilde;o</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" maxlength="260" required="true" id="descricao" tittle="Preencha este campo com letras ou numeros, até 30 caracteres." 
                                   name="descricao" placeholder="Digite a descrição do Anp." value={$descricao}>
                        </div>
                    </div>
            </div>
