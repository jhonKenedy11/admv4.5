              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-primary"  onClick="javascript:submitGerarFinanceiro();">
                ...
                <div class="x_content small">
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                                <input type="text" class="form-control" id="fornecedorNome" name="fornecedorNome" disabled value="{$fornecedorNome}">
                            </div>
                        </div>
                        </h5>    
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            ...
                            <div class="panel panel-default">
                                <select id="condPgto" name="condPgto" class="form-control" onChange="javascript:submitAtualPedidoCondPG('N');">
                                ...
                                <table id="datatable-buttons-1" class="table table-bordered jambo_table">
                                    <thead>
                                        <tr style="background: gray; color: white;">
                                            ...
                                            <th>Obs</th>
                                            <td style="width: 50px;"> <button type="button" class="btn btn-success btn-xs" onClick="javascript:submitAtualPedidoCondPG('S',{$numParcelaAdd});"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button> </td>
                                            <td style="width: 20px;"> <button type="button" class="btn btn-warning btn-xs" onClick="javascript:submitAtualPedidoCondPG('S',{-2}");"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button> </td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        {section name=i loop=$fin}
                                            ...
                                            <tr id="dados_financeiro" >
                                                ...
                                                <td> 
                                                    <input class="form-control" type="text" id="valor" name="valor{$fin[i].PARCELA}" value={$fin[i].VALOR}>
