        ...
        <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <h3 class="pull-left"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span>   Consolida&ccedil;&atilde;o Fiscal</h3>
                          ...
                          <table id="datatable-buttons" class="table table-bordered jambo_table small">
                            ...
                            <tbody>
                                ...
                                {section name=i loop=$lanc}
                                        ...
                                        {assign var="icms" value=$icms+$lanc[i].ICMS}
                                        {assign var="pis" value=$pis+$lanc[i].PIS}
                                        {assign var="cofins" value=$cofins+$lanc[i].COFINS}
                                    ...
                                    <tr bgcolor="{cycle values="#EBEBEB,#FFFFFF"}">
                                        ...
                                        <td> {$lanc[i].ICMS|number_format:2:",":"."} </td>
                                        <td> {$lanc[i].ALIQPIS|number_format:2:",":"."} </td>
                                        <td> {$lanc[i].PIS|number_format:2:",":"."} </td>
                                        <td> {$lanc[i].ALIQCOFINS|number_format:2:",":"."} </td>
                                        <td> {$lanc[i].COFINS|number_format:2:",":"."} </td>
                                ...
                                {/section}
                                    ...
                                    <tr bgcolor="{cycle values="#EBEBEB,#FFFFFF"}">
                                        ...
                                        <td>  </td>
                                        <td> {$icms|number_format:2:",":"."} </td>
                                        <td>  </td>
                                        <td> {$pis|number_format:2:",":"."} </td>
                                        <td>  </td>
                                        <td> {$cofins|number_format:2:",":"."} </td>
                                    </tr>
                            </tbody>
                        </table>
